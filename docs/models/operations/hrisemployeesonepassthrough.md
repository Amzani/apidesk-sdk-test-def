...
```typescript
import { HrisEmployeesOnePassThrough } from "apideck/models/operations";

let value: HrisEmployeesOnePassThrough = {
  serviceId: "<id>",
  extendPaths: [
    {
...
| `extendPaths`                                                                                                                                                               | [operations.HrisEmployeesOneExtendPaths](../../models/operations/hrisemployeesoneextendpaths.md)[]                                                                          | :heavy_minus_sign:                                                                                                                                                          | Array of objects for structured data modifications via paths.                                                                                                               |