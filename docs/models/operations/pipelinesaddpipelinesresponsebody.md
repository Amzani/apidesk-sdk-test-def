...
```typescript
import { PipelinesAddPipelinesResponseBody } from "apideck/models/operations";

let value: PipelinesAddPipelinesResponseBody = {
  statusCode: 400,
  error: "Bad Request",
...
| `detail`                                                                                    | *operations.PipelinesAddDetail*                                                             | :heavy_minus_sign:                                                                          | Contains parameter or domain specific information related to the error and why it occurred. |                                                                                             |
