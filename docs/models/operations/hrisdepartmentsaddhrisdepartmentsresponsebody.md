...
```typescript
import { HrisDepartmentsAddHrisDepartmentsResponseBody } from "apideck/models/operations";

let value: HrisDepartmentsAddHrisDepartmentsResponseBody = {
  statusCode: 400,
  error: "Bad Request",
...
| `detail`                                                                                    | *operations.HrisDepartmentsAddDetail*                                                       | :heavy_minus_sign:                                                                          | Contains parameter or domain specific information related to the error and why it occurred. |                                                                                             |
