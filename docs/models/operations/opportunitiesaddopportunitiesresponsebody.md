...
```typescript
import { OpportunitiesAddOpportunitiesResponseBody } from "apideck/models/operations";

let value: OpportunitiesAddOpportunitiesResponseBody = {
  statusCode: 400,
  error: "Bad Request",
...
| `detail`                                                                                    | *operations.OpportunitiesAddDetail*                                                         | :heavy_minus_sign:                                                                          | Contains parameter or domain specific information related to the error and why it occurred. |                                                                                             |
