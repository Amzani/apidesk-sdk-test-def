...
```typescript
import { HrisTimeOffRequestsAllPassThrough } from "apideck/models/operations";

let value: HrisTimeOffRequestsAllPassThrough = {
  serviceId: "<id>",
  extendPaths: [
    {
...
| `extendPaths`                                                                                                                                                               | [operations.HrisTimeOffRequestsAllExtendPaths](../../models/operations/hristimeoffrequestsallextendpaths.md)[]                                                              | :heavy_minus_sign:                                                                                                                                                          | Array of objects for structured data modifications via paths.                                                                                                               |