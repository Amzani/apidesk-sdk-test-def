...
```typescript
import { NotesOneNotesResponseBody } from "apideck/models/operations";

let value: NotesOneNotesResponseBody = {
  statusCode: 400,
  error: "Bad Request",
...
| `detail`                                                                                    | *operations.NotesOneDetail*                                                                 | :heavy_minus_sign:                                                                          | Contains parameter or domain specific information related to the error and why it occurred. |                                                                                             |
