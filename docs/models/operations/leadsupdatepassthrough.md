...
```typescript
import { LeadsUpdatePassThrough } from "apideck/models/operations";

let value: LeadsUpdatePassThrough = {
  serviceId: "<id>",
  extendPaths: [
    {
...
| `extendPaths`                                                                                                                                                               | [operations.LeadsUpdateExtendPaths](../../models/operations/leadsupdateextendpaths.md)[]                                                                                    | :heavy_minus_sign:                                                                                                                                                          | Array of objects for structured data modifications via paths.                                                                                                               |