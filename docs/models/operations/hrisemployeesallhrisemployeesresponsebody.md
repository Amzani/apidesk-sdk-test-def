...
```typescript
import { HrisEmployeesAllHrisEmployeesResponseBody } from "apideck/models/operations";

let value: HrisEmployeesAllHrisEmployeesResponseBody = {
  statusCode: 400,
  error: "Bad Request",
...
| `detail`                                                                                    | *operations.Detail*                                                                         | :heavy_minus_sign:                                                                          | Contains parameter or domain specific information related to the error and why it occurred. |                                                                                             |
