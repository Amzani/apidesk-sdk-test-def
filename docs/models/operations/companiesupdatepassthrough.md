...
```typescript
import { CompaniesUpdatePassThrough } from "apideck/models/operations";

let value: CompaniesUpdatePassThrough = {
  serviceId: "<id>",
  extendPaths: [
    {
...
| `extendPaths`                                                                                                                                                               | [operations.CompaniesUpdateExtendPaths](../../models/operations/companiesupdateextendpaths.md)[]                                                                            | :heavy_minus_sign:                                                                                                                                                          | Array of objects for structured data modifications via paths.                                                                                                               |