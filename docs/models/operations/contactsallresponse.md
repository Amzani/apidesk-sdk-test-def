...
### `operations.ContactsAllResponseBody`

```typescript
const value: operations.ContactsAllResponseBody = {
  statusCode: 200,
  status: "OK",
  service: "zoho-crm",
  resource: "contacts",
...
### `operations.ContactsAllContactsResponseBody`

```typescript
const value: operations.ContactsAllContactsResponseBody = {
  statusCode: 400,
  error: "Bad Request",
