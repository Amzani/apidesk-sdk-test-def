...
```typescript
import { HrisPayrollsOneHrisPayrollsResponseBody } from "apideck/models/operations";

let value: HrisPayrollsOneHrisPayrollsResponseBody = {
  statusCode: 400,
  error: "Bad Request",
...
| `detail`                                                                                    | *operations.HrisPayrollsOneDetail*                                                          | :heavy_minus_sign:                                                                          | Contains parameter or domain specific information related to the error and why it occurred. |                                                                                             |
