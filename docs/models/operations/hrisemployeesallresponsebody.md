...
```typescript
import { HrisEmployeesAllResponseBody } from "apideck/models/operations";
import { RFCDate } from "apideck/types";

let value: HrisEmployeesAllResponseBody = {
  statusCode: 200,
  status: "OK",
  service: "sage-hr",
  resource: "Employees",
...
| `meta`                                                      | [operations.Meta](../../models/operations/meta.md)          | :heavy_minus_sign:                                          | Response metadata                                           |                                                             |
| `links`                                                     | [operations.Links](../../models/operations/links.md)        | :heavy_minus_sign:                                          | Links to navigate to previous or next pages through the API |                                                             |