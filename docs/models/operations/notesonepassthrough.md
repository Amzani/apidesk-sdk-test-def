...
```typescript
import { NotesOnePassThrough } from "apideck/models/operations";

let value: NotesOnePassThrough = {
  serviceId: "<id>",
  extendPaths: [
    {
...
| `extendPaths`                                                                                                                                                               | [operations.NotesOneExtendPaths](../../models/operations/notesoneextendpaths.md)[]                                                                                          | :heavy_minus_sign:                                                                                                                                                          | Array of objects for structured data modifications via paths.                                                                                                               |