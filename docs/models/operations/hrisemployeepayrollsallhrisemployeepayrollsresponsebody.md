...
```typescript
import { HrisEmployeePayrollsAllHrisEmployeePayrollsResponseBody } from "apideck/models/operations";

let value: HrisEmployeePayrollsAllHrisEmployeePayrollsResponseBody = {
  statusCode: 400,
  error: "Bad Request",
...
| `detail`                                                                                    | *operations.HrisEmployeePayrollsAllDetail*                                                  | :heavy_minus_sign:                                                                          | Contains parameter or domain specific information related to the error and why it occurred. |                                                                                             |
