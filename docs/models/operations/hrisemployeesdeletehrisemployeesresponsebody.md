...
```typescript
import { HrisEmployeesDeleteHrisEmployeesResponseBody } from "apideck/models/operations";

let value: HrisEmployeesDeleteHrisEmployeesResponseBody = {
  statusCode: 400,
  error: "Bad Request",
...
| `detail`                                                                                    | *operations.HrisEmployeesDeleteDetail*                                                      | :heavy_minus_sign:                                                                          | Contains parameter or domain specific information related to the error and why it occurred. |                                                                                             |
