...
```typescript
import { HrisTimeOffRequestsUpdatePassThrough } from "apideck/models/operations";

let value: HrisTimeOffRequestsUpdatePassThrough = {
  serviceId: "<id>",
  extendPaths: [
    {
...
| `extendPaths`                                                                                                                                                               | [operations.HrisTimeOffRequestsUpdateExtendPaths](../../models/operations/hristimeoffrequestsupdateextendpaths.md)[]                                                        | :heavy_minus_sign:                                                                                                                                                          | Array of objects for structured data modifications via paths.                                                                                                               |