...
```typescript
import { HrisEmployeesUpdateHrisEmployeesResponseBody } from "apideck/models/operations";

let value: HrisEmployeesUpdateHrisEmployeesResponseBody = {
  statusCode: 400,
  error: "Bad Request",
...
| `detail`                                                                                    | *operations.HrisEmployeesUpdateDetail*                                                      | :heavy_minus_sign:                                                                          | Contains parameter or domain specific information related to the error and why it occurred. |                                                                                             |
