...
```typescript
import { HrisCompaniesDeleteHrisCompaniesResponseBody } from "apideck/models/operations";

let value: HrisCompaniesDeleteHrisCompaniesResponseBody = {
  statusCode: 400,
  error: "Bad Request",
...
| `detail`                                                                                    | *operations.HrisCompaniesDeleteDetail*                                                      | :heavy_minus_sign:                                                                          | Contains parameter or domain specific information related to the error and why it occurred. |                                                                                             |
