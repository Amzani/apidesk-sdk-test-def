...
```typescript
import { HrisTimeOffRequestsUpdateHrisTimeOffRequestsResponseBody } from "apideck/models/operations";

let value: HrisTimeOffRequestsUpdateHrisTimeOffRequestsResponseBody = {
  statusCode: 400,
  error: "Bad Request",
...
| `detail`                                                                                    | *operations.HrisTimeOffRequestsUpdateDetail*                                                | :heavy_minus_sign:                                                                          | Contains parameter or domain specific information related to the error and why it occurred. |                                                                                             |
