...
```typescript
import { OpportunitiesUpdateCustomFields } from "apideck/models/operations";

let value: OpportunitiesUpdateCustomFields = {
  id: "2389328923893298",
  name: "employee_level",
...
| `value`                                 | *operations.OpportunitiesUpdateValue*   | :heavy_minus_sign:                      | N/A                                     |                                         |