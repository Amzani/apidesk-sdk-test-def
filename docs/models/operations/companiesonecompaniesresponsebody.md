...
```typescript
import { CompaniesOneCompaniesResponseBody } from "apideck/models/operations";

let value: CompaniesOneCompaniesResponseBody = {
  statusCode: 400,
  error: "Bad Request",
...
| `detail`                                                                                    | *operations.CompaniesOneDetail*                                                             | :heavy_minus_sign:                                                                          | Contains parameter or domain specific information related to the error and why it occurred. |                                                                                             |
