...
```typescript
import { LeadsUpdateLeadsResponseBody } from "apideck/models/operations";

let value: LeadsUpdateLeadsResponseBody = {
  statusCode: 400,
  error: "Bad Request",
...
| `detail`                                                                                    | *operations.LeadsUpdateDetail*                                                              | :heavy_minus_sign:                                                                          | Contains parameter or domain specific information related to the error and why it occurred. |                                                                                             |
