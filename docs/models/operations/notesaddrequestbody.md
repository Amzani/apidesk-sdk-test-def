...
```typescript
import { NotesAddRequestBody } from "apideck/models/operations";

let value: NotesAddRequestBody = {
  title: "Meeting Notes",
...
| `passThrough`                                                                                                                                           | [operations.NotesAddPassThrough](../../models/operations/notesaddpassthrough.md)[]                                                                      | :heavy_minus_sign:                                                                                                                                      | The pass_through property allows passing service-specific, custom data or structured modifications in request body when creating or updating resources. |                                                                                                                                                         |