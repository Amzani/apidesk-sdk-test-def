...
```typescript
import { ActivitiesAllActivitiesResponseBody } from "apideck/models/operations";

let value: ActivitiesAllActivitiesResponseBody = {
  statusCode: 400,
  error: "Bad Request",
...
| `detail`                                                                                    | *operations.ActivitiesAllDetail*                                                            | :heavy_minus_sign:                                                                          | Contains parameter or domain specific information related to the error and why it occurred. |                                                                                             |
