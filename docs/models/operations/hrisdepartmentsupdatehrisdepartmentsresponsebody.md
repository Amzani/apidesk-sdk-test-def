...
```typescript
import { HrisDepartmentsUpdateHrisDepartmentsResponseBody } from "apideck/models/operations";

let value: HrisDepartmentsUpdateHrisDepartmentsResponseBody = {
  statusCode: 400,
  error: "Bad Request",
...
| `detail`                                                                                    | *operations.HrisDepartmentsUpdateDetail*                                                    | :heavy_minus_sign:                                                                          | Contains parameter or domain specific information related to the error and why it occurred. |                                                                                             |
