...
```typescript
import { UsersAllResponseBody } from "apideck/models/operations";

let value: UsersAllResponseBody = {
  statusCode: 400,
  error: "Bad Request",
...
| `detail`                                                                                    | *operations.UsersAllDetail*                                                                 | :heavy_minus_sign:                                                                          | Contains parameter or domain specific information related to the error and why it occurred. |                                                                                             |
