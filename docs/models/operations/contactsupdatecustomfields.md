...
```typescript
import { ContactsUpdateCustomFields } from "apideck/models/operations";

let value: ContactsUpdateCustomFields = {
  id: "2389328923893298",
  name: "employee_level",
...
| `value`                                 | *operations.ContactsUpdateValue*        | :heavy_minus_sign:                      | N/A                                     |                                         |