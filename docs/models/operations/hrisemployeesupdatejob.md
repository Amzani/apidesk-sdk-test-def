...
```typescript
import { HrisEmployeesUpdateJob } from "apideck/models/operations";
import { RFCDate } from "apideck/types";

let value: HrisEmployeesUpdateJob = {
  title: "CEO",
  role: "Sales",
...
| `currency`                                                                                                                         | [operations.HrisEmployeesUpdateCurrency](../../models/operations/hrisemployeesupdatecurrency.md)                                   | :heavy_minus_sign:                                                                                                                 | Indicates the associated currency for an amount of money. Values correspond to [ISO 4217](https://en.wikipedia.org/wiki/ISO_4217). | USD                                                                                                                                |
| `paymentUnit`                                                                                                                      | [operations.HrisEmployeesUpdatePaymentUnit](../../models/operations/hrisemployeesupdatepaymentunit.md)                             | :heavy_minus_sign:                                                                                                                 | Unit of measurement for employee compensation.                                                                                     | year                                                                                                                               |
...
| `status`                                                                                                                           | [operations.HrisEmployeesUpdateStatus](../../models/operations/hrisemployeesupdatestatus.md)                                       | :heavy_minus_sign:                                                                                                                 | Indicates the status of the job.                                                                                                   | active                                                                                                                             |
| `location`                                                                                                                         | [operations.HrisEmployeesUpdateLocation](../../models/operations/hrisemployeesupdatelocation.md)                                   | :heavy_minus_sign:                                                                                                                 | N/A                                                                                                                                |                                                                                                                                    |