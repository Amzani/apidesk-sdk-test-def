...
```typescript
import { HrisCompaniesUpdatePassThrough } from "apideck/models/operations";

let value: HrisCompaniesUpdatePassThrough = {
  serviceId: "<id>",
  extendPaths: [
    {
...
| `extendPaths`                                                                                                                                                               | [operations.HrisCompaniesUpdateExtendPaths](../../models/operations/hriscompaniesupdateextendpaths.md)[]                                                                    | :heavy_minus_sign:                                                                                                                                                          | Array of objects for structured data modifications via paths.                                                                                                               |