...
```typescript
import { ContactsOnePassThrough } from "apideck/models/operations";

let value: ContactsOnePassThrough = {
  serviceId: "<id>",
  extendPaths: [
    {
...
| `extendPaths`                                                                                                                                                               | [operations.ContactsOneExtendPaths](../../models/operations/contactsoneextendpaths.md)[]                                                                                    | :heavy_minus_sign:                                                                                                                                                          | Array of objects for structured data modifications via paths.                                                                                                               |