...
```typescript
import { ActivitiesUpdateCustomFields } from "apideck/models/operations";

let value: ActivitiesUpdateCustomFields = {
  id: "2389328923893298",
  name: "employee_level",
...
| `value`                                 | *operations.ActivitiesUpdateValue*      | :heavy_minus_sign:                      | N/A                                     |                                         |