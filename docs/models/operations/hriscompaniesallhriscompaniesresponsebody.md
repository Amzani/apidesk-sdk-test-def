...
```typescript
import { HrisCompaniesAllHrisCompaniesResponseBody } from "apideck/models/operations";

let value: HrisCompaniesAllHrisCompaniesResponseBody = {
  statusCode: 400,
  error: "Bad Request",
...
| `detail`                                                                                    | *operations.HrisCompaniesAllDetail*                                                         | :heavy_minus_sign:                                                                          | Contains parameter or domain specific information related to the error and why it occurred. |                                                                                             |
