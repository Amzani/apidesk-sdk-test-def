...
```typescript
import { CompaniesDeleteCompaniesResponseBody } from "apideck/models/operations";

let value: CompaniesDeleteCompaniesResponseBody = {
  statusCode: 400,
  error: "Bad Request",
...
| `detail`                                                                                    | *operations.CompaniesDeleteDetail*                                                          | :heavy_minus_sign:                                                                          | Contains parameter or domain specific information related to the error and why it occurred. |                                                                                             |
