...
```typescript
import { NotesAddNotesResponseBody } from "apideck/models/operations";

let value: NotesAddNotesResponseBody = {
  statusCode: 400,
  error: "Bad Request",
...
| `detail`                                                                                    | *operations.NotesAddDetail*                                                                 | :heavy_minus_sign:                                                                          | Contains parameter or domain specific information related to the error and why it occurred. |                                                                                             |
