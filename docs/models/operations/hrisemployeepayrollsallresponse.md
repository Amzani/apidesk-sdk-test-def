...
### `operations.HrisEmployeePayrollsAllResponseBody`

```typescript
const value: operations.HrisEmployeePayrollsAllResponseBody = {
  statusCode: 200,
  status: "OK",
  service: "sage-hr",
  resource: "Employees",
...
### `operations.HrisEmployeePayrollsAllHrisEmployeePayrollsResponseBody`
