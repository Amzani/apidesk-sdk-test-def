...
```typescript
import { HrisTimeOffRequestsOneHrisTimeOffRequestsResponseBody } from "apideck/models/operations";

let value: HrisTimeOffRequestsOneHrisTimeOffRequestsResponseBody = {
  statusCode: 400,
  error: "Bad Request",
...
| `detail`                                                                                    | *operations.HrisTimeOffRequestsOneDetail*                                                   | :heavy_minus_sign:                                                                          | Contains parameter or domain specific information related to the error and why it occurred. |                                                                                             |
