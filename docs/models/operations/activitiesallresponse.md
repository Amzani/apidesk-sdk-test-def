...
### `operations.ActivitiesAllResponseBody`

```typescript
const value: operations.ActivitiesAllResponseBody = {
  statusCode: 200,
  status: "OK",
  service: "zoho-crm",
  resource: "activities",
...
### `operations.ActivitiesAllActivitiesResponseBody`

```typescript
const value: operations.ActivitiesAllActivitiesResponseBody = {
  statusCode: 400,
  error: "Bad Request",
