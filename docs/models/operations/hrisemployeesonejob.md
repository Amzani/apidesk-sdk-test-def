...
```typescript
import { HrisEmployeesOneJob } from "apideck/models/operations";
import { RFCDate } from "apideck/types";

let value: HrisEmployeesOneJob = {
  id: "12345",
  employeeId: "12345",
  title: "CEO",
  role: "Sales",
...
| `currency`                                                                                                                         | [operations.HrisEmployeesOneCurrency](../../models/operations/hrisemployeesonecurrency.md)                                         | :heavy_minus_sign:                                                                                                                 | Indicates the associated currency for an amount of money. Values correspond to [ISO 4217](https://en.wikipedia.org/wiki/ISO_4217). | USD                                                                                                                                |
| `paymentUnit`                                                                                                                      | [operations.HrisEmployeesOnePaymentUnit](../../models/operations/hrisemployeesonepaymentunit.md)                                   | :heavy_minus_sign:                                                                                                                 | Unit of measurement for employee compensation.                                                                                     | year                                                                                                                               |
...
| `status`                                                                                                                           | [operations.HrisEmployeesOneStatus](../../models/operations/hrisemployeesonestatus.md)                                             | :heavy_minus_sign:                                                                                                                 | Indicates the status of the job.                                                                                                   | active                                                                                                                             |
| `location`                                                                                                                         | [operations.HrisEmployeesOneLocation](../../models/operations/hrisemployeesonelocation.md)                                         | :heavy_minus_sign:                                                                                                                 | N/A                                                                                                                                |                                                                                                                                    |