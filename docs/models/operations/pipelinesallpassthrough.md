...
```typescript
import { PipelinesAllPassThrough } from "apideck/models/operations";

let value: PipelinesAllPassThrough = {
  serviceId: "<id>",
  extendPaths: [
    {
...
| `extendPaths`                                                                                                                                                               | [operations.PipelinesAllExtendPaths](../../models/operations/pipelinesallextendpaths.md)[]                                                                                  | :heavy_minus_sign:                                                                                                                                                          | Array of objects for structured data modifications via paths.                                                                                                               |