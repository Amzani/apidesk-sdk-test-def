...
```typescript
import { HrisDepartmentsAllPassThrough } from "apideck/models/operations";

let value: HrisDepartmentsAllPassThrough = {
  serviceId: "<id>",
  extendPaths: [
    {
...
| `extendPaths`                                                                                                                                                               | [operations.HrisDepartmentsAllExtendPaths](../../models/operations/hrisdepartmentsallextendpaths.md)[]                                                                      | :heavy_minus_sign:                                                                                                                                                          | Array of objects for structured data modifications via paths.                                                                                                               |