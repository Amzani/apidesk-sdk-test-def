...
### `operations.HrisEmployeesOneResponseBody`

```typescript
const value: operations.HrisEmployeesOneResponseBody = {
  statusCode: 200,
  status: "OK",
  service: "sage-hr",
  resource: "Employees",
...
### `operations.HrisEmployeesOneHrisEmployeesResponseBody`

```typescript
const value: operations.HrisEmployeesOneHrisEmployeesResponseBody = {
  statusCode: 400,
  error: "Bad Request",
