...
```typescript
import { ContactsOneResponse } from "apideck/models/operations";

let value: ContactsOneResponse = {
  httpMeta: {
...
| `contactGetResponse`                                                                     | [components.ContactGetResponse](../../models/components/contactgetresponse.md)           | :heavy_minus_sign:                                                                       | Contact                                                                                  |
