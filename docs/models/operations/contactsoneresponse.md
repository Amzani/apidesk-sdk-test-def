...
### `operations.ContactsOneResponseBody`

```typescript
const value: operations.ContactsOneResponseBody = {
  statusCode: 200,
  status: "OK",
  service: "zoho-crm",
  resource: "companies",
...
### `operations.ContactsOneContactsResponseBody`

```typescript
const value: operations.ContactsOneContactsResponseBody = {
  statusCode: 400,
  error: "Bad Request",
