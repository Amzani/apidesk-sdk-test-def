...
```typescript
import { PipelinesAllPipelinesResponseBody } from "apideck/models/operations";

let value: PipelinesAllPipelinesResponseBody = {
  statusCode: 400,
  error: "Bad Request",
...
| `detail`                                                                                    | *operations.PipelinesAllDetail*                                                             | :heavy_minus_sign:                                                                          | Contains parameter or domain specific information related to the error and why it occurred. |                                                                                             |
