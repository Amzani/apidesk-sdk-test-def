...
```typescript
import { PipelinesUpdatePipelinesResponseBody } from "apideck/models/operations";

let value: PipelinesUpdatePipelinesResponseBody = {
  statusCode: 400,
  error: "Bad Request",
...
| `detail`                                                                                    | *operations.PipelinesUpdateDetail*                                                          | :heavy_minus_sign:                                                                          | Contains parameter or domain specific information related to the error and why it occurred. |                                                                                             |
