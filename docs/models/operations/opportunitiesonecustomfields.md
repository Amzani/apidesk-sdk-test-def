...
```typescript
import { OpportunitiesOneCustomFields } from "apideck/models/operations";

let value: OpportunitiesOneCustomFields = {
  id: "2389328923893298",
  name: "employee_level",
...
| `value`                                 | *operations.OpportunitiesOneValue*      | :heavy_minus_sign:                      | N/A                                     |                                         |