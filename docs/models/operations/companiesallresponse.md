...
### `operations.CompaniesAllResponseBody`

```typescript
const value: operations.CompaniesAllResponseBody = {
  statusCode: 200,
  status: "OK",
  service: "zoho-crm",
  resource: "companies",
...
### `operations.CompaniesAllCompaniesResponseBody`

```typescript
const value: operations.CompaniesAllCompaniesResponseBody = {
  statusCode: 400,
  error: "Bad Request",
