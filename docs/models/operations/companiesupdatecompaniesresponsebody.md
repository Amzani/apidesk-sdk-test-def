...
```typescript
import { CompaniesUpdateCompaniesResponseBody } from "apideck/models/operations";

let value: CompaniesUpdateCompaniesResponseBody = {
  statusCode: 400,
  error: "Bad Request",
...
| `detail`                                                                                    | *operations.CompaniesUpdateDetail*                                                          | :heavy_minus_sign:                                                                          | Contains parameter or domain specific information related to the error and why it occurred. |                                                                                             |
