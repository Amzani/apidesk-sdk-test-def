...
```typescript
import { ActivitiesAddCustomFields } from "apideck/models/operations";

let value: ActivitiesAddCustomFields = {
  id: "2389328923893298",
  name: "employee_level",
...
| `value`                                 | *operations.ActivitiesAddValue*         | :heavy_minus_sign:                      | N/A                                     |                                         |