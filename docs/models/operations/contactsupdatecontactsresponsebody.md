...
```typescript
import { ContactsUpdateContactsResponseBody } from "apideck/models/operations";

let value: ContactsUpdateContactsResponseBody = {
  statusCode: 400,
  error: "Bad Request",
...
| `detail`                                                                                    | *operations.ContactsUpdateDetail*                                                           | :heavy_minus_sign:                                                                          | Contains parameter or domain specific information related to the error and why it occurred. |                                                                                             |
