...
```typescript
import { ActivitiesAllCustomFields } from "apideck/models/operations";

let value: ActivitiesAllCustomFields = {
  id: "2389328923893298",
  name: "employee_level",
...
| `value`                                 | *operations.ActivitiesAllValue*         | :heavy_minus_sign:                      | N/A                                     |                                         |