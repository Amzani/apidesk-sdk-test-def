...
```typescript
import { ContactsAllContactsResponseBody } from "apideck/models/operations";

let value: ContactsAllContactsResponseBody = {
  statusCode: 400,
  error: "Bad Request",
...
| `detail`                                                                                    | *operations.ContactsAllDetail*                                                              | :heavy_minus_sign:                                                                          | Contains parameter or domain specific information related to the error and why it occurred. |                                                                                             |
