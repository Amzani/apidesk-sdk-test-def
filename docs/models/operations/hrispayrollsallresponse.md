...
### `operations.HrisPayrollsAllResponseBody`

```typescript
const value: operations.HrisPayrollsAllResponseBody = {
  statusCode: 200,
  status: "OK",
  service: "sage-hr",
  resource: "Employees",
...
### `operations.HrisPayrollsAllHrisPayrollsResponseBody`

```typescript
const value: operations.HrisPayrollsAllHrisPayrollsResponseBody = {
  statusCode: 400,
  error: "Bad Request",
