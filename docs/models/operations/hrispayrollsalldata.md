...
```typescript
import { HrisPayrollsAllData } from "apideck/models/operations";

let value: HrisPayrollsAllData = {
  id: "12345",
  companyId: "23456",
  processed: false,
...
| `totals`                                                                                                    | [operations.Totals](../../models/operations/totals.md)                                                      | :heavy_minus_sign:                                                                                          | The overview of the payroll totals.                                                                         |                                                                                                             |
| `compensations`                                                                                             | [operations.Compensations](../../models/operations/compensations.md)[]                                      | :heavy_minus_sign:                                                                                          | An array of compensations for the payroll.                                                                  |                                                                                                             |
| `customMappings`                                                                                            | [operations.HrisPayrollsAllCustomMappings](../../models/operations/hrispayrollsallcustommappings.md)        | :heavy_minus_sign:                                                                                          | When custom mappings are configured on the resource, the result is included here.                           |                                                                                                             |