...
```typescript
import { PipelinesUpdateRequest } from "apideck/models/operations";

let value: PipelinesUpdateRequest = {
  id: "<id>",
...
| `requestBody`                                                                                                                                 | [operations.PipelinesUpdateRequestBody](../../models/operations/pipelinesupdaterequestbody.md)                                                | :heavy_check_mark:                                                                                                                            | N/A                                                                                                                                           |                                                                                                                                               |