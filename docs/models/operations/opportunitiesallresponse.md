...
### `operations.OpportunitiesAllResponseBody`

```typescript
const value: operations.OpportunitiesAllResponseBody = {
  statusCode: 200,
  status: "OK",
  service: "zoho-crm",
...
### `operations.OpportunitiesAllOpportunitiesResponseBody`

```typescript
const value: operations.OpportunitiesAllOpportunitiesResponseBody = {
  statusCode: 400,
  error: "Bad Request",
