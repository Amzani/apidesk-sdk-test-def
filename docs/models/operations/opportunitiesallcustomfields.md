...
```typescript
import { OpportunitiesAllCustomFields } from "apideck/models/operations";

let value: OpportunitiesAllCustomFields = {
  id: "2389328923893298",
  name: "employee_level",
...
| `value`                                 | *operations.OpportunitiesAllValue*      | :heavy_minus_sign:                      | N/A                                     |                                         |