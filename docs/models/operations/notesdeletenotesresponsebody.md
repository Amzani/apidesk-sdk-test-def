...
```typescript
import { NotesDeleteNotesResponseBody } from "apideck/models/operations";

let value: NotesDeleteNotesResponseBody = {
  statusCode: 400,
  error: "Bad Request",
...
| `detail`                                                                                    | *operations.NotesDeleteDetail*                                                              | :heavy_minus_sign:                                                                          | Contains parameter or domain specific information related to the error and why it occurred. |                                                                                             |
