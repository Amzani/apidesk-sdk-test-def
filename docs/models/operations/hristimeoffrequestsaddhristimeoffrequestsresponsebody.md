...
```typescript
import { HrisTimeOffRequestsAddHrisTimeOffRequestsResponseBody } from "apideck/models/operations";

let value: HrisTimeOffRequestsAddHrisTimeOffRequestsResponseBody = {
  statusCode: 400,
  error: "Bad Request",
...
| `detail`                                                                                    | *operations.HrisTimeOffRequestsAddDetail*                                                   | :heavy_minus_sign:                                                                          | Contains parameter or domain specific information related to the error and why it occurred. |                                                                                             |
