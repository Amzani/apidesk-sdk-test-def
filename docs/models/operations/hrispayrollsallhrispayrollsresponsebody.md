...
```typescript
import { HrisPayrollsAllHrisPayrollsResponseBody } from "apideck/models/operations";

let value: HrisPayrollsAllHrisPayrollsResponseBody = {
  statusCode: 400,
  error: "Bad Request",
...
| `detail`                                                                                    | *operations.HrisPayrollsAllDetail*                                                          | :heavy_minus_sign:                                                                          | Contains parameter or domain specific information related to the error and why it occurred. |                                                                                             |
