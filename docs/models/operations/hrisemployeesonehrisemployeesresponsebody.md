...
```typescript
import { HrisEmployeesOneHrisEmployeesResponseBody } from "apideck/models/operations";

let value: HrisEmployeesOneHrisEmployeesResponseBody = {
  statusCode: 400,
  error: "Bad Request",
...
| `detail`                                                                                    | *operations.HrisEmployeesOneDetail*                                                         | :heavy_minus_sign:                                                                          | Contains parameter or domain specific information related to the error and why it occurred. |                                                                                             |
