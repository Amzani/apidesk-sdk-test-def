...
```typescript
import { CompaniesAllCompaniesResponseBody } from "apideck/models/operations";

let value: CompaniesAllCompaniesResponseBody = {
  statusCode: 400,
  error: "Bad Request",
...
| `detail`                                                                                    | *operations.CompaniesAllDetail*                                                             | :heavy_minus_sign:                                                                          | Contains parameter or domain specific information related to the error and why it occurred. |                                                                                             |
