...
```typescript
import { OpportunitiesOneOpportunitiesResponseBody } from "apideck/models/operations";

let value: OpportunitiesOneOpportunitiesResponseBody = {
  statusCode: 400,
  error: "Bad Request",
...
| `detail`                                                                                    | *operations.OpportunitiesOneDetail*                                                         | :heavy_minus_sign:                                                                          | Contains parameter or domain specific information related to the error and why it occurred. |                                                                                             |
