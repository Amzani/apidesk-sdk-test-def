...
```typescript
import { HrisDepartmentsOneHrisDepartmentsResponseBody } from "apideck/models/operations";

let value: HrisDepartmentsOneHrisDepartmentsResponseBody = {
  statusCode: 400,
  error: "Bad Request",
...
| `detail`                                                                                    | *operations.HrisDepartmentsOneDetail*                                                       | :heavy_minus_sign:                                                                          | Contains parameter or domain specific information related to the error and why it occurred. |                                                                                             |
