...
### `operations.CompaniesOneResponseBody`

```typescript
const value: operations.CompaniesOneResponseBody = {
  statusCode: 200,
  status: "OK",
  service: "zoho-crm",
  resource: "companies",
...
### `operations.CompaniesOneCompaniesResponseBody`

```typescript
const value: operations.CompaniesOneCompaniesResponseBody = {
  statusCode: 400,
  error: "Bad Request",
