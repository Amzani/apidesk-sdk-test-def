...
```typescript
import { CompaniesOneResponse } from "apideck/models/operations";
import { RFCDate } from "apideck/types";

let value: CompaniesOneResponse = {
  httpMeta: {
...
| `companyGetResponse`                                                                     | [components.CompanyGetResponse](../../models/components/companygetresponse.md)           | :heavy_minus_sign:                                                                       | Company                                                                                  |
