...
```typescript
import { HrisCompaniesUpdateHrisCompaniesResponseBody } from "apideck/models/operations";

let value: HrisCompaniesUpdateHrisCompaniesResponseBody = {
  statusCode: 400,
  error: "Bad Request",
...
| `detail`                                                                                    | *operations.HrisCompaniesUpdateDetail*                                                      | :heavy_minus_sign:                                                                          | Contains parameter or domain specific information related to the error and why it occurred. |                                                                                             |
