...
```typescript
import { NotesAllNotesResponseBody } from "apideck/models/operations";

let value: NotesAllNotesResponseBody = {
  statusCode: 400,
  error: "Bad Request",
...
| `detail`                                                                                    | *operations.NotesAllDetail*                                                                 | :heavy_minus_sign:                                                                          | Contains parameter or domain specific information related to the error and why it occurred. |                                                                                             |
