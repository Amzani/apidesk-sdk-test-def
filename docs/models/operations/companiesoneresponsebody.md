...
```typescript
import { CompaniesOneResponseBody } from "apideck/models/operations";
import { RFCDate } from "apideck/types";

let value: CompaniesOneResponseBody = {
  statusCode: 200,
  status: "OK",
  service: "zoho-crm",
  resource: "companies",
...
| `data`                                                                     | [operations.CompaniesOneData](../../models/operations/companiesonedata.md) | :heavy_check_mark:                                                         | N/A                                                                        |                                                                            |