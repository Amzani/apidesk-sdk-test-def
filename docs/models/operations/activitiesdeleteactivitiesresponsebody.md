...
```typescript
import { ActivitiesDeleteActivitiesResponseBody } from "apideck/models/operations";

let value: ActivitiesDeleteActivitiesResponseBody = {
  statusCode: 400,
  error: "Bad Request",
...
| `detail`                                                                                    | *operations.ActivitiesDeleteDetail*                                                         | :heavy_minus_sign:                                                                          | Contains parameter or domain specific information related to the error and why it occurred. |                                                                                             |
