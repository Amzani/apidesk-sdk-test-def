...
```typescript
import { HrisTimeOffRequestsDeleteHrisTimeOffRequestsResponseBody } from "apideck/models/operations";

let value: HrisTimeOffRequestsDeleteHrisTimeOffRequestsResponseBody = {
  statusCode: 400,
  error: "Bad Request",
...
| `detail`                                                                                    | *operations.HrisTimeOffRequestsDeleteDetail*                                                | :heavy_minus_sign:                                                                          | Contains parameter or domain specific information related to the error and why it occurred. |                                                                                             |
