...
```typescript
import { HrisEmployeeSchedulesAllData } from "apideck/models/operations";
import { RFCDate } from "apideck/types";

let value: HrisEmployeeSchedulesAllData = {
  employee: {
    id: "12345",
    firstName: "Elon",
    lastName: "Musk",
...
| -------------------------------------------------------------- | -------------------------------------------------------------- | -------------------------------------------------------------- | -------------------------------------------------------------- |
| `employee`                                                     | [operations.Employee](../../models/operations/employee.md)     | :heavy_minus_sign:                                             | N/A                                                            |
| `schedules`                                                    | [operations.Schedules](../../models/operations/schedules.md)[] | :heavy_minus_sign:                                             | N/A                                                            |