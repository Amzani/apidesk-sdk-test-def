...
```typescript
import { PipelinesOnePipelinesResponseBody } from "apideck/models/operations";

let value: PipelinesOnePipelinesResponseBody = {
  statusCode: 400,
  error: "Bad Request",
...
| `detail`                                                                                    | *operations.PipelinesOneDetail*                                                             | :heavy_minus_sign:                                                                          | Contains parameter or domain specific information related to the error and why it occurred. |                                                                                             |
