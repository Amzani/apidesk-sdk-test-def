...
```typescript
import { OpportunitiesDeleteOpportunitiesResponseBody } from "apideck/models/operations";

let value: OpportunitiesDeleteOpportunitiesResponseBody = {
  statusCode: 400,
  error: "Bad Request",
...
| `detail`                                                                                    | *operations.OpportunitiesDeleteDetail*                                                      | :heavy_minus_sign:                                                                          | Contains parameter or domain specific information related to the error and why it occurred. |                                                                                             |
