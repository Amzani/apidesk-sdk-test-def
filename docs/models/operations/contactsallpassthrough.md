...
```typescript
import { ContactsAllPassThrough } from "apideck/models/operations";

let value: ContactsAllPassThrough = {
  serviceId: "<id>",
  extendPaths: [
    {
...
| `extendPaths`                                                                                                                                                               | [operations.ContactsAllExtendPaths](../../models/operations/contactsallextendpaths.md)[]                                                                                    | :heavy_minus_sign:                                                                                                                                                          | Array of objects for structured data modifications via paths.                                                                                                               |