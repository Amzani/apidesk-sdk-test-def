...
```typescript
import { LeadsAddLeadsResponseBody } from "apideck/models/operations";

let value: LeadsAddLeadsResponseBody = {
  statusCode: 400,
  error: "Bad Request",
...
| `detail`                                                                                    | *operations.LeadsAddDetail*                                                                 | :heavy_minus_sign:                                                                          | Contains parameter or domain specific information related to the error and why it occurred. |                                                                                             |
