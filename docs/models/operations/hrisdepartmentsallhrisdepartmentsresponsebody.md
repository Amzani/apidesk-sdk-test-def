...
```typescript
import { HrisDepartmentsAllHrisDepartmentsResponseBody } from "apideck/models/operations";

let value: HrisDepartmentsAllHrisDepartmentsResponseBody = {
  statusCode: 400,
  error: "Bad Request",
...
| `detail`                                                                                    | *operations.HrisDepartmentsAllDetail*                                                       | :heavy_minus_sign:                                                                          | Contains parameter or domain specific information related to the error and why it occurred. |                                                                                             |
