...
```typescript
import { UsersOneResponseBody } from "apideck/models/operations";

let value: UsersOneResponseBody = {
  statusCode: 400,
  error: "Bad Request",
...
| `detail`                                                                                    | *operations.UsersOneDetail*                                                                 | :heavy_minus_sign:                                                                          | Contains parameter or domain specific information related to the error and why it occurred. |                                                                                             |
