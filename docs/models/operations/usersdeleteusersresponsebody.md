...
```typescript
import { UsersDeleteUsersResponseBody } from "apideck/models/operations";

let value: UsersDeleteUsersResponseBody = {
  statusCode: 400,
  error: "Bad Request",
...
| `detail`                                                                                    | *operations.UsersDeleteDetail*                                                              | :heavy_minus_sign:                                                                          | Contains parameter or domain specific information related to the error and why it occurred. |                                                                                             |
