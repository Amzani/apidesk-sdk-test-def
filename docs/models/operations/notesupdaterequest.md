...
```typescript
import { NotesUpdateRequest } from "apideck/models/operations";

let value: NotesUpdateRequest = {
  id: "<id>",
...
| `requestBody`                                                                                                                                 | [operations.NotesUpdateRequestBody](../../models/operations/notesupdaterequestbody.md)                                                        | :heavy_check_mark:                                                                                                                            | N/A                                                                                                                                           |                                                                                                                                               |