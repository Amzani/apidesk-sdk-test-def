...
```typescript
import { UsersUpdatePassThrough } from "apideck/models/operations";

let value: UsersUpdatePassThrough = {
  serviceId: "<id>",
  extendPaths: [
    {
...
| `extendPaths`                                                                                                                                                               | [operations.UsersUpdateExtendPaths](../../models/operations/usersupdateextendpaths.md)[]                                                                                    | :heavy_minus_sign:                                                                                                                                                          | Array of objects for structured data modifications via paths.                                                                                                               |