...
```typescript
import { LeadsAllLeadsResponseBody } from "apideck/models/operations";

let value: LeadsAllLeadsResponseBody = {
  statusCode: 400,
  error: "Bad Request",
...
| `detail`                                                                                    | *operations.LeadsAllDetail*                                                                 | :heavy_minus_sign:                                                                          | Contains parameter or domain specific information related to the error and why it occurred. |                                                                                             |
