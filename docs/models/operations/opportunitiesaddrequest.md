...
```typescript
import { OpportunitiesAddRequest } from "apideck/models/operations";
import { RFCDate } from "apideck/types";

let value: OpportunitiesAddRequest = {
...
| `opportunityCreateRequest`                                                                                                                                                                                                                                   | [components.OpportunityCreateRequest](../../models/components/opportunitycreaterequest.md)                                                                                                                                                                   | :heavy_check_mark:                                                                                                                                                                                                                                           | N/A                                                                                                                                                                                                                                                          |                                                                                                                                                                                                                                                              |