...
```typescript
import { CompaniesOneCustomFields } from "apideck/models/operations";

let value: CompaniesOneCustomFields = {
  id: "2389328923893298",
  name: "employee_level",
...
| `value`                                 | *operations.CompaniesOneValue*          | :heavy_minus_sign:                      | N/A                                     |                                         |