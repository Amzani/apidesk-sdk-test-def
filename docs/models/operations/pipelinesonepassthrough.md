...
```typescript
import { PipelinesOnePassThrough } from "apideck/models/operations";

let value: PipelinesOnePassThrough = {
  serviceId: "<id>",
  extendPaths: [
    {
...
| `extendPaths`                                                                                                                                                               | [operations.PipelinesOneExtendPaths](../../models/operations/pipelinesoneextendpaths.md)[]                                                                                  | :heavy_minus_sign:                                                                                                                                                          | Array of objects for structured data modifications via paths.                                                                                                               |