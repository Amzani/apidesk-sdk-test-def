...
```typescript
import { UsersUpdateUsersResponseBody } from "apideck/models/operations";

let value: UsersUpdateUsersResponseBody = {
  statusCode: 400,
  error: "Bad Request",
...
| `detail`                                                                                    | *operations.UsersUpdateDetail*                                                              | :heavy_minus_sign:                                                                          | Contains parameter or domain specific information related to the error and why it occurred. |                                                                                             |
