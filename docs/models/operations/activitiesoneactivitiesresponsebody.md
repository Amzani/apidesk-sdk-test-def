...
```typescript
import { ActivitiesOneActivitiesResponseBody } from "apideck/models/operations";

let value: ActivitiesOneActivitiesResponseBody = {
  statusCode: 400,
  error: "Bad Request",
...
| `detail`                                                                                    | *operations.ActivitiesOneDetail*                                                            | :heavy_minus_sign:                                                                          | Contains parameter or domain specific information related to the error and why it occurred. |                                                                                             |
