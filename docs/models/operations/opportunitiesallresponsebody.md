...
```typescript
import { OpportunitiesAllResponseBody } from "apideck/models/operations";
import { RFCDate } from "apideck/types";

let value: OpportunitiesAllResponseBody = {
  statusCode: 200,
  status: "OK",
  service: "zoho-crm",
...
| `data`                                                                               | [operations.OpportunitiesAllData](../../models/operations/opportunitiesalldata.md)[] | :heavy_check_mark:                                                                   | N/A                                                                                  |                                                                                      |
| `meta`                                                                               | [operations.OpportunitiesAllMeta](../../models/operations/opportunitiesallmeta.md)   | :heavy_minus_sign:                                                                   | Response metadata                                                                    |                                                                                      |
| `links`                                                                              | [operations.OpportunitiesAllLinks](../../models/operations/opportunitiesalllinks.md) | :heavy_minus_sign:                                                                   | Links to navigate to previous or next pages through the API                          |                                                                                      |