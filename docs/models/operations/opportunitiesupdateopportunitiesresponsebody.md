...
```typescript
import { OpportunitiesUpdateOpportunitiesResponseBody } from "apideck/models/operations";

let value: OpportunitiesUpdateOpportunitiesResponseBody = {
  statusCode: 400,
  error: "Bad Request",
...
| `detail`                                                                                    | *operations.OpportunitiesUpdateDetail*                                                      | :heavy_minus_sign:                                                                          | Contains parameter or domain specific information related to the error and why it occurred. |                                                                                             |
