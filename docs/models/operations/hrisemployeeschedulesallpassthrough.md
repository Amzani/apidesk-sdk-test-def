...
```typescript
import { HrisEmployeeSchedulesAllPassThrough } from "apideck/models/operations";

let value: HrisEmployeeSchedulesAllPassThrough = {
  serviceId: "<id>",
  extendPaths: [
    {
...
| `extendPaths`                                                                                                                                                               | [operations.HrisEmployeeSchedulesAllExtendPaths](../../models/operations/hrisemployeeschedulesallextendpaths.md)[]                                                          | :heavy_minus_sign:                                                                                                                                                          | Array of objects for structured data modifications via paths.                                                                                                               |