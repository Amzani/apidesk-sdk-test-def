...
```typescript
import { ActivitiesUpdatePassThrough } from "apideck/models/operations";

let value: ActivitiesUpdatePassThrough = {
  serviceId: "<id>",
  extendPaths: [
    {
...
| `extendPaths`                                                                                                                                                               | [operations.ActivitiesUpdateExtendPaths](../../models/operations/activitiesupdateextendpaths.md)[]                                                                          | :heavy_minus_sign:                                                                                                                                                          | Array of objects for structured data modifications via paths.                                                                                                               |