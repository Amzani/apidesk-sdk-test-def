...
```typescript
import { OpportunitiesOneResponse } from "apideck/models/operations";
import { RFCDate } from "apideck/types";

let value: OpportunitiesOneResponse = {
  httpMeta: {
...
| `opportunityGetResponse`                                                                 | [components.OpportunityGetResponse](../../models/components/opportunitygetresponse.md)   | :heavy_minus_sign:                                                                       | Opportunity                                                                              |
