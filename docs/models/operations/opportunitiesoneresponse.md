...
### `operations.OpportunitiesOneResponseBody`

```typescript
const value: operations.OpportunitiesOneResponseBody = {
  statusCode: 200,
  status: "OK",
  service: "zoho-crm",
...
### `operations.OpportunitiesOneOpportunitiesResponseBody`

```typescript
const value: operations.OpportunitiesOneOpportunitiesResponseBody = {
  statusCode: 400,
  error: "Bad Request",
