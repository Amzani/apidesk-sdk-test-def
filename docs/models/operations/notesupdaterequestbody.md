...
```typescript
import { NotesUpdateRequestBody } from "apideck/models/operations";

let value: NotesUpdateRequestBody = {
  title: "Meeting Notes",
...
| `passThrough`                                                                                                                                           | [operations.NotesUpdatePassThrough](../../models/operations/notesupdatepassthrough.md)[]                                                                | :heavy_minus_sign:                                                                                                                                      | The pass_through property allows passing service-specific, custom data or structured modifications in request body when creating or updating resources. |                                                                                                                                                         |