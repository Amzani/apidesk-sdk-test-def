...
```typescript
import { OpportunitiesOnePassThrough } from "apideck/models/operations";

let value: OpportunitiesOnePassThrough = {
  serviceId: "<id>",
  extendPaths: [
    {
...
| `extendPaths`                                                                                                                                                               | [operations.OpportunitiesOneExtendPaths](../../models/operations/opportunitiesoneextendpaths.md)[]                                                                          | :heavy_minus_sign:                                                                                                                                                          | Array of objects for structured data modifications via paths.                                                                                                               |