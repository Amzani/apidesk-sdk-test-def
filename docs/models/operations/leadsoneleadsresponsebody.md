...
```typescript
import { LeadsOneLeadsResponseBody } from "apideck/models/operations";

let value: LeadsOneLeadsResponseBody = {
  statusCode: 400,
  error: "Bad Request",
...
| `detail`                                                                                    | *operations.LeadsOneDetail*                                                                 | :heavy_minus_sign:                                                                          | Contains parameter or domain specific information related to the error and why it occurred. |                                                                                             |
