...
```typescript
import { HrisEmployeeSchedulesAllResponseBody } from "apideck/models/operations";
import { RFCDate } from "apideck/types";

let value: HrisEmployeeSchedulesAllResponseBody = {
  statusCode: 200,
  status: "OK",
  service: "sage-hr",
  resource: "Employees",
...
| `data`                                                                                             | [operations.HrisEmployeeSchedulesAllData](../../models/operations/hrisemployeeschedulesalldata.md) | :heavy_check_mark:                                                                                 | N/A                                                                                                |                                                                                                    |