...
```typescript
import { LeadsAllPassThrough } from "apideck/models/operations";

let value: LeadsAllPassThrough = {
  serviceId: "<id>",
  extendPaths: [
    {
...
| `extendPaths`                                                                                                                                                               | [operations.LeadsAllExtendPaths](../../models/operations/leadsallextendpaths.md)[]                                                                                          | :heavy_minus_sign:                                                                                                                                                          | Array of objects for structured data modifications via paths.                                                                                                               |