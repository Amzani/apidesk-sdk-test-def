...
```typescript
import { HrisDepartmentsDeleteHrisDepartmentsResponseBody } from "apideck/models/operations";

let value: HrisDepartmentsDeleteHrisDepartmentsResponseBody = {
  statusCode: 400,
  error: "Bad Request",
...
| `detail`                                                                                    | *operations.HrisDepartmentsDeleteDetail*                                                    | :heavy_minus_sign:                                                                          | Contains parameter or domain specific information related to the error and why it occurred. |                                                                                             |
