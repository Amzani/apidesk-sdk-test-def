...
```typescript
import { ActivitiesAllPassThrough } from "apideck/models/operations";

let value: ActivitiesAllPassThrough = {
  serviceId: "<id>",
  extendPaths: [
    {
...
| `extendPaths`                                                                                                                                                               | [operations.ActivitiesAllExtendPaths](../../models/operations/activitiesallextendpaths.md)[]                                                                                | :heavy_minus_sign:                                                                                                                                                          | Array of objects for structured data modifications via paths.                                                                                                               |