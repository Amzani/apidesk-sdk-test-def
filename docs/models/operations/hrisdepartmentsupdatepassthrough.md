...
```typescript
import { HrisDepartmentsUpdatePassThrough } from "apideck/models/operations";

let value: HrisDepartmentsUpdatePassThrough = {
  serviceId: "<id>",
  extendPaths: [
    {
...
| `extendPaths`                                                                                                                                                               | [operations.HrisDepartmentsUpdateExtendPaths](../../models/operations/hrisdepartmentsupdateextendpaths.md)[]                                                                | :heavy_minus_sign:                                                                                                                                                          | Array of objects for structured data modifications via paths.                                                                                                               |