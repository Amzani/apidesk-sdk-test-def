...
```typescript
import { NotesUpdateNotesResponseBody } from "apideck/models/operations";

let value: NotesUpdateNotesResponseBody = {
  statusCode: 400,
  error: "Bad Request",
...
| `detail`                                                                                    | *operations.NotesUpdateDetail*                                                              | :heavy_minus_sign:                                                                          | Contains parameter or domain specific information related to the error and why it occurred. |                                                                                             |
