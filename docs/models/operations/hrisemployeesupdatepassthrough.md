...
```typescript
import { HrisEmployeesUpdatePassThrough } from "apideck/models/operations";

let value: HrisEmployeesUpdatePassThrough = {
  serviceId: "<id>",
  extendPaths: [
    {
...
| `extendPaths`                                                                                                                                                               | [operations.HrisEmployeesUpdateExtendPaths](../../models/operations/hrisemployeesupdateextendpaths.md)[]                                                                    | :heavy_minus_sign:                                                                                                                                                          | Array of objects for structured data modifications via paths.                                                                                                               |