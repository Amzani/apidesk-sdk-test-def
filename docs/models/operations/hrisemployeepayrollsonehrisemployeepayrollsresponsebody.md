...
```typescript
import { HrisEmployeePayrollsOneHrisEmployeePayrollsResponseBody } from "apideck/models/operations";

let value: HrisEmployeePayrollsOneHrisEmployeePayrollsResponseBody = {
  statusCode: 400,
  error: "Bad Request",
...
| `detail`                                                                                    | *operations.HrisEmployeePayrollsOneDetail*                                                  | :heavy_minus_sign:                                                                          | Contains parameter or domain specific information related to the error and why it occurred. |                                                                                             |
