...
```typescript
import { ActivitiesAddActivitiesResponseBody } from "apideck/models/operations";

let value: ActivitiesAddActivitiesResponseBody = {
  statusCode: 400,
  error: "Bad Request",
...
| `detail`                                                                                    | *operations.ActivitiesAddDetail*                                                            | :heavy_minus_sign:                                                                          | Contains parameter or domain specific information related to the error and why it occurred. |                                                                                             |
