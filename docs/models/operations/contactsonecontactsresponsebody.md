...
```typescript
import { ContactsOneContactsResponseBody } from "apideck/models/operations";

let value: ContactsOneContactsResponseBody = {
  statusCode: 400,
  error: "Bad Request",
...
| `detail`                                                                                    | *operations.ContactsOneDetail*                                                              | :heavy_minus_sign:                                                                          | Contains parameter or domain specific information related to the error and why it occurred. |                                                                                             |
