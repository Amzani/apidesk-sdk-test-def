...
```typescript
import { HrisEmployeesAllCustomFields } from "apideck/models/operations";

let value: HrisEmployeesAllCustomFields = {
  id: "2389328923893298",
  name: "employee_level",
...
| `value`                                 | *operations.HrisEmployeesAllValue*      | :heavy_minus_sign:                      | N/A                                     |                                         |