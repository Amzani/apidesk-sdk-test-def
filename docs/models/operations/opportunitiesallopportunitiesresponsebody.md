...
```typescript
import { OpportunitiesAllOpportunitiesResponseBody } from "apideck/models/operations";

let value: OpportunitiesAllOpportunitiesResponseBody = {
  statusCode: 400,
  error: "Bad Request",
...
| `detail`                                                                                    | *operations.OpportunitiesAllDetail*                                                         | :heavy_minus_sign:                                                                          | Contains parameter or domain specific information related to the error and why it occurred. |                                                                                             |
