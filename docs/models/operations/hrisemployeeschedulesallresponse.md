...
### `operations.HrisEmployeeSchedulesAllResponseBody`

```typescript
const value: operations.HrisEmployeeSchedulesAllResponseBody = {
  statusCode: 200,
  status: "OK",
  service: "sage-hr",
  resource: "Employees",
...
### `operations.HrisEmployeeSchedulesAllHrisEmployeeSchedulesResponseBody`
