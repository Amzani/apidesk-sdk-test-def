...
```typescript
import { ContactsDeleteContactsResponseBody } from "apideck/models/operations";

let value: ContactsDeleteContactsResponseBody = {
  statusCode: 400,
  error: "Bad Request",
...
| `detail`                                                                                    | *operations.ContactsDeleteDetail*                                                           | :heavy_minus_sign:                                                                          | Contains parameter or domain specific information related to the error and why it occurred. |                                                                                             |
