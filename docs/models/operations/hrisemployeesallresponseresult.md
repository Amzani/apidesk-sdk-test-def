...
### `operations.HrisEmployeesAllResponseBody`

```typescript
const value: operations.HrisEmployeesAllResponseBody = {
  statusCode: 200,
  status: "OK",
  service: "sage-hr",
  resource: "Employees",
...
### `operations.HrisEmployeesAllHrisEmployeesResponseBody`

```typescript
const value: operations.HrisEmployeesAllHrisEmployeesResponseBody = {
  statusCode: 400,
  error: "Bad Request",
