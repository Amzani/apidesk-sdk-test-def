...
```typescript
import { PipelinesDeletePipelinesResponseBody } from "apideck/models/operations";

let value: PipelinesDeletePipelinesResponseBody = {
  statusCode: 400,
  error: "Bad Request",
...
| `detail`                                                                                    | *operations.PipelinesDeleteDetail*                                                          | :heavy_minus_sign:                                                                          | Contains parameter or domain specific information related to the error and why it occurred. |                                                                                             |
