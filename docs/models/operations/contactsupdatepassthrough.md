...
```typescript
import { ContactsUpdatePassThrough } from "apideck/models/operations";

let value: ContactsUpdatePassThrough = {
  serviceId: "<id>",
  extendPaths: [
    {
...
| `extendPaths`                                                                                                                                                               | [operations.ContactsUpdateExtendPaths](../../models/operations/contactsupdateextendpaths.md)[]                                                                              | :heavy_minus_sign:                                                                                                                                                          | Array of objects for structured data modifications via paths.                                                                                                               |