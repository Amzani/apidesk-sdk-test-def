...
```typescript
import { UsersAddUsersResponseBody } from "apideck/models/operations";

let value: UsersAddUsersResponseBody = {
  statusCode: 400,
  error: "Bad Request",
...
| `detail`                                                                                    | *operations.UsersAddDetail*                                                                 | :heavy_minus_sign:                                                                          | Contains parameter or domain specific information related to the error and why it occurred. |                                                                                             |
