...
### `operations.ActivitiesOneResponseBody`

```typescript
const value: operations.ActivitiesOneResponseBody = {
  statusCode: 200,
  status: "OK",
  service: "zoho-crm",
  resource: "activities",
...
### `operations.ActivitiesOneActivitiesResponseBody`

```typescript
const value: operations.ActivitiesOneActivitiesResponseBody = {
  statusCode: 400,
  error: "Bad Request",
