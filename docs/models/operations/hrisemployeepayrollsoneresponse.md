...
### `operations.HrisEmployeePayrollsOneResponseBody`

```typescript
const value: operations.HrisEmployeePayrollsOneResponseBody = {
  statusCode: 200,
  status: "OK",
  service: "undefined",
  resource: "Companies",
...
### `operations.HrisEmployeePayrollsOneHrisEmployeePayrollsResponseBody`
