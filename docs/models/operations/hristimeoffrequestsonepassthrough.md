...
```typescript
import { HrisTimeOffRequestsOnePassThrough } from "apideck/models/operations";

let value: HrisTimeOffRequestsOnePassThrough = {
  serviceId: "<id>",
  extendPaths: [
    {
...
| `extendPaths`                                                                                                                                                               | [operations.HrisTimeOffRequestsOneExtendPaths](../../models/operations/hristimeoffrequestsoneextendpaths.md)[]                                                              | :heavy_minus_sign:                                                                                                                                                          | Array of objects for structured data modifications via paths.                                                                                                               |