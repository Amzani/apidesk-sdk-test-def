...
```typescript
import { HrisCompaniesOneHrisCompaniesResponseBody } from "apideck/models/operations";

let value: HrisCompaniesOneHrisCompaniesResponseBody = {
  statusCode: 400,
  error: "Bad Request",
...
| `detail`                                                                                    | *operations.HrisCompaniesOneDetail*                                                         | :heavy_minus_sign:                                                                          | Contains parameter or domain specific information related to the error and why it occurred. |                                                                                             |
