...
```typescript
import { HrisTimeOffRequestsAllHrisTimeOffRequestsResponseBody } from "apideck/models/operations";

let value: HrisTimeOffRequestsAllHrisTimeOffRequestsResponseBody = {
  statusCode: 400,
  error: "Bad Request",
...
| `detail`                                                                                    | *operations.HrisTimeOffRequestsAllDetail*                                                   | :heavy_minus_sign:                                                                          | Contains parameter or domain specific information related to the error and why it occurred. |                                                                                             |
