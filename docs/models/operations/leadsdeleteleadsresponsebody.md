...
```typescript
import { LeadsDeleteLeadsResponseBody } from "apideck/models/operations";

let value: LeadsDeleteLeadsResponseBody = {
  statusCode: 400,
  error: "Bad Request",
...
| `detail`                                                                                    | *operations.LeadsDeleteDetail*                                                              | :heavy_minus_sign:                                                                          | Contains parameter or domain specific information related to the error and why it occurred. |                                                                                             |
