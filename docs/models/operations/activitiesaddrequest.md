...
```typescript
import { ActivitiesAddRequest } from "apideck/models/operations";

let value: ActivitiesAddRequest = {
...
| `activityCreateRequest`                                                                                                                                                                                                                                      | [components.ActivityCreateRequest](../../models/components/activitycreaterequest.md)                                                                                                                                                                         | :heavy_check_mark:                                                                                                                                                                                                                                           | N/A                                                                                                                                                                                                                                                          |                                                                                                                                                                                                                                                              |