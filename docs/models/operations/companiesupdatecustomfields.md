...
```typescript
import { CompaniesUpdateCustomFields } from "apideck/models/operations";

let value: CompaniesUpdateCustomFields = {
  id: "2389328923893298",
  name: "employee_level",
...
| `value`                                 | *operations.CompaniesUpdateValue*       | :heavy_minus_sign:                      | N/A                                     |                                         |