...
```typescript
import { ActivitiesOneCustomFields } from "apideck/models/operations";

let value: ActivitiesOneCustomFields = {
  id: "2389328923893298",
  name: "employee_level",
...
| `value`                                 | *operations.ActivitiesOneValue*         | :heavy_minus_sign:                      | N/A                                     |                                         |