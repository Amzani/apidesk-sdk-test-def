...
```typescript
import { HrisEmployeesAllPassThrough } from "apideck/models/operations";

let value: HrisEmployeesAllPassThrough = {
  serviceId: "<id>",
  extendPaths: [
    {
...
| `extendPaths`                                                                                                                                                               | [operations.HrisEmployeesAllExtendPaths](../../models/operations/hrisemployeesallextendpaths.md)[]                                                                          | :heavy_minus_sign:                                                                                                                                                          | Array of objects for structured data modifications via paths.                                                                                                               |