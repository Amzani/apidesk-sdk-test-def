...
```typescript
import { ContactsAddContactsResponseBody } from "apideck/models/operations";

let value: ContactsAddContactsResponseBody = {
  statusCode: 400,
  error: "Bad Request",
...
| `detail`                                                                                    | *operations.ContactsAddDetail*                                                              | :heavy_minus_sign:                                                                          | Contains parameter or domain specific information related to the error and why it occurred. |                                                                                             |
