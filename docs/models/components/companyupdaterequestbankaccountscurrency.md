# CompanyUpdateRequestBankAccountsCurrency
...
```typescript
import { CompanyUpdateRequestBankAccountsCurrency } from "apideck/models/components";

let value: CompanyUpdateRequestBankAccountsCurrency = "USD";
```
