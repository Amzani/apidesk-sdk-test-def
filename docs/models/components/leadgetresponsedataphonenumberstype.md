# LeadGetResponseDataPhoneNumbersType
...
```typescript
import { LeadGetResponseDataPhoneNumbersType } from "apideck/models/components";

let value: LeadGetResponseDataPhoneNumbersType = "primary";
```
