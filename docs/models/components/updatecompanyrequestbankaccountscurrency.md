# UpdateCompanyRequestBankAccountsCurrency
...
```typescript
import { UpdateCompanyRequestBankAccountsCurrency } from "apideck/models/components";

let value: UpdateCompanyRequestBankAccountsCurrency = "USD";
```
