# UserUpdateRequestPhoneNumbersType
...
```typescript
import { UserUpdateRequestPhoneNumbersType } from "apideck/models/components";

let value: UserUpdateRequestPhoneNumbersType = "primary";
```
