# ContactsListResponseDataPhoneNumbersType
...
```typescript
import { ContactsListResponseDataPhoneNumbersType } from "apideck/models/components";

let value: ContactsListResponseDataPhoneNumbersType = "primary";
```
