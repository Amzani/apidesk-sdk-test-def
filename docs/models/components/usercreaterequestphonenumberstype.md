# UserCreateRequestPhoneNumbersType
...
```typescript
import { UserCreateRequestPhoneNumbersType } from "apideck/models/components";

let value: UserCreateRequestPhoneNumbersType = "primary";
```
