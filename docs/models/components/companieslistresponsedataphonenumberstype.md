# CompaniesListResponseDataPhoneNumbersType
...
```typescript
import { CompaniesListResponseDataPhoneNumbersType } from "apideck/models/components";

let value: CompaniesListResponseDataPhoneNumbersType = "primary";
```
