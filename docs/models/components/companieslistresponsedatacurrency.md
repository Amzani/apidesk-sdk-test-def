# CompaniesListResponseDataCurrency
...
```typescript
import { CompaniesListResponseDataCurrency } from "apideck/models/components";

let value: CompaniesListResponseDataCurrency = "USD";
```
