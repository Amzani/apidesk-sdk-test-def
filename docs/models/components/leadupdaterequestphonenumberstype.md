# LeadUpdateRequestPhoneNumbersType
...
```typescript
import { LeadUpdateRequestPhoneNumbersType } from "apideck/models/components";

let value: LeadUpdateRequestPhoneNumbersType = "primary";
```
