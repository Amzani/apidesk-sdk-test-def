...
```typescript
import { NotesUpdateResponseBody } from "apideck/models/errors";
...
| `detail`                                                                                    | *errors.NotesUpdateDetail*                                                                  | :heavy_minus_sign:                                                                          | Contains parameter or domain specific information related to the error and why it occurred. |                                                                                             |
