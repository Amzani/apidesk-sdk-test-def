...
```typescript
import { HrisDepartmentsAddHrisDepartmentsResponseBody } from "apideck/models/errors";
...
| `detail`                                                                                    | *errors.HrisDepartmentsAddHrisDepartmentsDetail*                                            | :heavy_minus_sign:                                                                          | Contains parameter or domain specific information related to the error and why it occurred. |                                                                                             |
