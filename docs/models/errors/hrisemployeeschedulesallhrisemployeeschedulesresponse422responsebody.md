...
```typescript
import { HrisEmployeeSchedulesAllHrisEmployeeSchedulesResponse422ResponseBody } from "apideck/models/errors";
...
| `detail`                                                                                    | *errors.HrisEmployeeSchedulesAllHrisEmployeeSchedulesResponse422Detail*                     | :heavy_minus_sign:                                                                          | Contains parameter or domain specific information related to the error and why it occurred. |                                                                                             |
