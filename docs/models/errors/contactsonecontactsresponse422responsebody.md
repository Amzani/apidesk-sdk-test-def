...
```typescript
import { ContactsOneContactsResponse422ResponseBody } from "apideck/models/errors";
...
| `detail`                                                                                    | *errors.ContactsOneContactsResponse422Detail*                                               | :heavy_minus_sign:                                                                          | Contains parameter or domain specific information related to the error and why it occurred. |                                                                                             |
