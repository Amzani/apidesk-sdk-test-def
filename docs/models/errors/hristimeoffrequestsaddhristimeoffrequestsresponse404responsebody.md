...
```typescript
import { HrisTimeOffRequestsAddHrisTimeOffRequestsResponse404ResponseBody } from "apideck/models/errors";
...
| `detail`                                                                                    | *errors.HrisTimeOffRequestsAddHrisTimeOffRequestsResponseDetail*                            | :heavy_minus_sign:                                                                          | Contains parameter or domain specific information related to the error and why it occurred. |                                                                                             |
