...
```typescript
import { PipelinesOneResponseBody } from "apideck/models/errors";
...
| `detail`                                                                                    | *errors.PipelinesOneDetail*                                                                 | :heavy_minus_sign:                                                                          | Contains parameter or domain specific information related to the error and why it occurred. |                                                                                             |
