...
```typescript
import { HrisCompaniesUpdateHrisCompaniesResponse422ResponseBody } from "apideck/models/errors";
...
| `detail`                                                                                    | *errors.HrisCompaniesUpdateHrisCompaniesResponse422Detail*                                  | :heavy_minus_sign:                                                                          | Contains parameter or domain specific information related to the error and why it occurred. |                                                                                             |
