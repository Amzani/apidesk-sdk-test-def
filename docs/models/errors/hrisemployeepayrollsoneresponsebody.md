...
```typescript
import { HrisEmployeePayrollsOneResponseBody } from "apideck/models/errors";
...
| `detail`                                                                                    | *errors.HrisEmployeePayrollsOneDetail*                                                      | :heavy_minus_sign:                                                                          | Contains parameter or domain specific information related to the error and why it occurred. |                                                                                             |
