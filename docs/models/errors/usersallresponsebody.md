...
```typescript
import { UsersAllResponseBody } from "apideck/models/errors";
...
| `detail`                                                                                    | *errors.UsersAllDetail*                                                                     | :heavy_minus_sign:                                                                          | Contains parameter or domain specific information related to the error and why it occurred. |                                                                                             |
