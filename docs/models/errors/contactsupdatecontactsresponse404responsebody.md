...
```typescript
import { ContactsUpdateContactsResponse404ResponseBody } from "apideck/models/errors";
...
| `detail`                                                                                    | *errors.ContactsUpdateContactsResponseDetail*                                               | :heavy_minus_sign:                                                                          | Contains parameter or domain specific information related to the error and why it occurred. |                                                                                             |
