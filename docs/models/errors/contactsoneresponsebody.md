...
```typescript
import { ContactsOneResponseBody } from "apideck/models/errors";
...
| `detail`                                                                                    | *errors.ContactsOneDetail*                                                                  | :heavy_minus_sign:                                                                          | Contains parameter or domain specific information related to the error and why it occurred. |                                                                                             |
