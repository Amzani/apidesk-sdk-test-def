...
```typescript
import { CompaniesAddCompaniesResponse422ResponseBody } from "apideck/models/errors";
...
| `detail`                                                                                    | *errors.CompaniesAddCompaniesResponseDetail*                                                | :heavy_minus_sign:                                                                          | Contains parameter or domain specific information related to the error and why it occurred. |                                                                                             |
