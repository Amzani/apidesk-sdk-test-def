...
```typescript
import { HrisDepartmentsDeleteResponseBody } from "apideck/models/errors";
...
| `detail`                                                                                    | *errors.HrisDepartmentsDeleteDetail*                                                        | :heavy_minus_sign:                                                                          | Contains parameter or domain specific information related to the error and why it occurred. |                                                                                             |
