...
```typescript
import { NotesUpdateNotesResponse404ResponseBody } from "apideck/models/errors";
...
| `detail`                                                                                    | *errors.NotesUpdateNotesResponseDetail*                                                     | :heavy_minus_sign:                                                                          | Contains parameter or domain specific information related to the error and why it occurred. |                                                                                             |
