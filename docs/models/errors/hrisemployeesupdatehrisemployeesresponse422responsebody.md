...
```typescript
import { HrisEmployeesUpdateHrisEmployeesResponse422ResponseBody } from "apideck/models/errors";
...
| `detail`                                                                                    | *errors.HrisEmployeesUpdateHrisEmployeesResponse422Detail*                                  | :heavy_minus_sign:                                                                          | Contains parameter or domain specific information related to the error and why it occurred. |                                                                                             |
