...
```typescript
import { PipelinesDeletePipelinesResponseBody } from "apideck/models/errors";
...
| `detail`                                                                                    | *errors.PipelinesDeletePipelinesDetail*                                                     | :heavy_minus_sign:                                                                          | Contains parameter or domain specific information related to the error and why it occurred. |                                                                                             |
