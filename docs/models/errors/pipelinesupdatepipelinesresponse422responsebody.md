...
```typescript
import { PipelinesUpdatePipelinesResponse422ResponseBody } from "apideck/models/errors";
...
| `detail`                                                                                    | *errors.PipelinesUpdatePipelinesResponse422Detail*                                          | :heavy_minus_sign:                                                                          | Contains parameter or domain specific information related to the error and why it occurred. |                                                                                             |
