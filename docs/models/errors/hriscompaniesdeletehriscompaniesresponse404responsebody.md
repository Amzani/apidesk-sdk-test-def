...
```typescript
import { HrisCompaniesDeleteHrisCompaniesResponse404ResponseBody } from "apideck/models/errors";
...
| `detail`                                                                                    | *errors.HrisCompaniesDeleteHrisCompaniesResponseDetail*                                     | :heavy_minus_sign:                                                                          | Contains parameter or domain specific information related to the error and why it occurred. |                                                                                             |
