...
```typescript
import { HrisPayrollsAllHrisPayrollsResponseBody } from "apideck/models/errors";
...
| `detail`                                                                                    | *errors.HrisPayrollsAllHrisPayrollsDetail*                                                  | :heavy_minus_sign:                                                                          | Contains parameter or domain specific information related to the error and why it occurred. |                                                                                             |
