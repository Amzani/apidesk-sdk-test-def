...
```typescript
import { ActivitiesUpdateActivitiesResponse422ResponseBody } from "apideck/models/errors";
...
| `detail`                                                                                    | *errors.ActivitiesUpdateActivitiesResponse422Detail*                                        | :heavy_minus_sign:                                                                          | Contains parameter or domain specific information related to the error and why it occurred. |                                                                                             |
