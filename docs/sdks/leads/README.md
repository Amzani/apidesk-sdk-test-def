...
* [leadsAll](#leadsall) - Retrieve a list of leads from the CRM system.
* [leadsAdd](#leadsadd) - Add a new lead to the CRM system.
* [leadsOne](#leadsone) - Retrieve a specific lead's details from the CRM.
* [leadsUpdate](#leadsupdate) - Update a lead record in the CRM system.
* [leadsDelete](#leadsdelete) - Delete a lead record from the CRM system.
