...
| --------------------------------------------------------------------------- | --------------------------------------------------------------------------- | --------------------------------------------------------------------------- |
| errors.HrisEmployeeSchedulesAllResponseBody                                 | 400                                                                         | application/json                                                            |
| errors.HrisEmployeeSchedulesAllHrisEmployeeSchedulesResponseBody            | 401                                                                         | application/json                                                            |
| errors.HrisEmployeeSchedulesAllHrisEmployeeSchedulesResponseResponseBody    | 402                                                                         | application/json                                                            |
| errors.HrisEmployeeSchedulesAllHrisEmployeeSchedulesResponse404ResponseBody | 404                                                                         | application/json                                                            |
| errors.HrisEmployeeSchedulesAllHrisEmployeeSchedulesResponse422ResponseBody | 422                                                                         | application/json                                                            |
