 ...
 */
export const ActivityCreateRequestType = {
  Call: "call",
  Meeting: "meeting",
  Email: "email",
  Note: "note",
 ...
 * The category or classification of the activity, such as 'call', 'meeting', or 'task'. This required field helps in organizing and filtering activities within the CRM, ensuring that users can easily identify and manage different types of interactions. It is crucial for reporting and analytics, as it allows businesses to analyze activity patterns and performance metrics. The type should be selected from predefined categories to maintain consistency across records.
 */
export type ActivityCreateRequestType = ClosedEnum<
  typeof ActivityCreateRequestType
>;
 ...
 */
export const ActivityCreateRequestLocationAddressType = {
  Primary: "primary",
  Secondary: "secondary",
  Home: "home",
  Office: "office",
 ...
 * Specifies the type of address, such as 'home', 'work', or 'billing'. This classification helps in organizing and retrieving addresses based on their usage context. It is important for applications that need to differentiate between various address types for operations like shipping or invoicing.
 */
export type ActivityCreateRequestLocationAddressType = ClosedEnum<
  typeof ActivityCreateRequestLocationAddressType
>;
...
export type LocationAddress = {
   ...
   * Specifies the type of address, such as 'home', 'work', or 'billing'. This classification helps in organizing and retrieving addresses based on their usage context. It is important for applications that need to differentiate between various address types for operations like shipping or invoicing.
   */
  type?: ActivityCreateRequestLocationAddressType | null | undefined;
  /**
...
export type ActivityCreateRequestValue6 = {};

export type ActivityCreateRequestValue4 = {};
 ...
 */
export type ActivityCreateRequestValue =
  | ActivityCreateRequestValue4
  | string
  | number
  | boolean
  | Array<string>
  | Array<ActivityCreateRequestValue6>;

export type ActivityCreateRequestCustomFields = {
  /**
...
export type ActivityCreateRequestAttendees = {
  /**
...
export type ActivityCreateRequestExtendPaths = {
  /**
...
export type ActivityCreateRequestPassThrough = {
  /**
   ...
   */
  extendPaths?: Array<ActivityCreateRequestExtendPaths> | undefined;
};
...
export type ActivityCreateRequest = {
   ...
   * The category or classification of the activity, such as 'call', 'meeting', or 'task'. This required field helps in organizing and filtering activities within the CRM, ensuring that users can easily identify and manage different types of interactions. It is crucial for reporting and analytics, as it allows businesses to analyze activity patterns and performance metrics. The type should be selected from predefined categories to maintain consistency across records.
   */
  type: ActivityCreateRequestType | null;
  /**
   ...
   */
  customFields?: Array<ActivityCreateRequestCustomFields> | undefined;
  /**
   ...
   */
  attendees?: Array<ActivityCreateRequestAttendees> | undefined;
  /**
   ...
   */
  passThrough?: Array<ActivityCreateRequestPassThrough> | undefined;
};

/** @internal */
export const ActivityCreateRequestType$inboundSchema: z.ZodNativeEnum<
  typeof ActivityCreateRequestType
> = z.nativeEnum(ActivityCreateRequestType);

/** @internal */
export const ActivityCreateRequestType$outboundSchema: z.ZodNativeEnum<
  typeof ActivityCreateRequestType
> = ActivityCreateRequestType$inboundSchema;

/**
 * @internal
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export namespace ActivityCreateRequestType$ {
  /** @deprecated use `ActivityCreateRequestType$inboundSchema` instead. */
  export const inboundSchema = ActivityCreateRequestType$inboundSchema;
  /** @deprecated use `ActivityCreateRequestType$outboundSchema` instead. */
  export const outboundSchema = ActivityCreateRequestType$outboundSchema;
}

/** @internal */
export const ActivityCreateRequestLocationAddressType$inboundSchema:
  z.ZodNativeEnum<typeof ActivityCreateRequestLocationAddressType> = z
    .nativeEnum(ActivityCreateRequestLocationAddressType);

/** @internal */
export const ActivityCreateRequestLocationAddressType$outboundSchema:
  z.ZodNativeEnum<typeof ActivityCreateRequestLocationAddressType> =
    ActivityCreateRequestLocationAddressType$inboundSchema;

/**
 * @internal
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export namespace ActivityCreateRequestLocationAddressType$ {
  /** @deprecated use `ActivityCreateRequestLocationAddressType$inboundSchema` instead. */
  export const inboundSchema =
    ActivityCreateRequestLocationAddressType$inboundSchema;
  /** @deprecated use `ActivityCreateRequestLocationAddressType$outboundSchema` instead. */
  export const outboundSchema =
    ActivityCreateRequestLocationAddressType$outboundSchema;
}
...
> = z.object({
  ...
  type: z.nullable(ActivityCreateRequestLocationAddressType$inboundSchema)
    .optional(),
...
> = z.object({
  id: z.nullable(z.string()).optional(),
  type: z.nullable(ActivityCreateRequestLocationAddressType$outboundSchema)
    .optional(),
  string: z.nullable(z.string()).optional(),
  name: z.nullable(z.string()).optional(),
  line1: z.nullable(z.string()).optional(),
...
/** @internal */
export const ActivityCreateRequestValue6$inboundSchema: z.ZodType<
  ActivityCreateRequestValue6,
  z.ZodTypeDef,
  unknown
> = z.object({});

/** @internal */
export type ActivityCreateRequestValue6$Outbound = {};

/** @internal */
export const ActivityCreateRequestValue6$outboundSchema: z.ZodType<
  ActivityCreateRequestValue6$Outbound,
  z.ZodTypeDef,
  ActivityCreateRequestValue6
> = z.object({});
 ...
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export namespace ActivityCreateRequestValue6$ {
  /** @deprecated use `ActivityCreateRequestValue6$inboundSchema` instead. */
  export const inboundSchema = ActivityCreateRequestValue6$inboundSchema;
  /** @deprecated use `ActivityCreateRequestValue6$outboundSchema` instead. */
  export const outboundSchema = ActivityCreateRequestValue6$outboundSchema;
  /** @deprecated use `ActivityCreateRequestValue6$Outbound` instead. */
  export type Outbound = ActivityCreateRequestValue6$Outbound;
}

export function activityCreateRequestValue6ToJSON(
  activityCreateRequestValue6: ActivityCreateRequestValue6,
): string {
  return JSON.stringify(
    ActivityCreateRequestValue6$outboundSchema.parse(
      activityCreateRequestValue6,
    ),
  );
}

export function activityCreateRequestValue6FromJSON(
  jsonString: string,
): SafeParseResult<ActivityCreateRequestValue6, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => ActivityCreateRequestValue6$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'ActivityCreateRequestValue6' from JSON`,
  );
}

/** @internal */
export const ActivityCreateRequestValue4$inboundSchema: z.ZodType<
  ActivityCreateRequestValue4,
  z.ZodTypeDef,
  unknown
> = z.object({});
...
/** @internal */
export type ActivityCreateRequestValue4$Outbound = {};

/** @internal */
export const ActivityCreateRequestValue4$outboundSchema: z.ZodType<
  ActivityCreateRequestValue4$Outbound,
  z.ZodTypeDef,
  ActivityCreateRequestValue4
> = z.object({});
 ...
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export namespace ActivityCreateRequestValue4$ {
  /** @deprecated use `ActivityCreateRequestValue4$inboundSchema` instead. */
  export const inboundSchema = ActivityCreateRequestValue4$inboundSchema;
  /** @deprecated use `ActivityCreateRequestValue4$outboundSchema` instead. */
  export const outboundSchema = ActivityCreateRequestValue4$outboundSchema;
  /** @deprecated use `ActivityCreateRequestValue4$Outbound` instead. */
  export type Outbound = ActivityCreateRequestValue4$Outbound;
}

export function activityCreateRequestValue4ToJSON(
  activityCreateRequestValue4: ActivityCreateRequestValue4,
): string {
  return JSON.stringify(
    ActivityCreateRequestValue4$outboundSchema.parse(
      activityCreateRequestValue4,
    ),
  );
}

export function activityCreateRequestValue4FromJSON(
  jsonString: string,
): SafeParseResult<ActivityCreateRequestValue4, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => ActivityCreateRequestValue4$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'ActivityCreateRequestValue4' from JSON`,
  );
}

/** @internal */
export const ActivityCreateRequestValue$inboundSchema: z.ZodType<
  ActivityCreateRequestValue,
  z.ZodTypeDef,
  unknown
> = z.union([
  z.lazy(() => ActivityCreateRequestValue4$inboundSchema),
  z.string(),
  z.number(),
  z.boolean(),
  z.array(z.string()),
  z.array(z.lazy(() => ActivityCreateRequestValue6$inboundSchema)),
]);

/** @internal */
export type ActivityCreateRequestValue$Outbound =
  | ActivityCreateRequestValue4$Outbound
  | string
  | number
  | boolean
  | Array<string>
  | Array<ActivityCreateRequestValue6$Outbound>;

/** @internal */
export const ActivityCreateRequestValue$outboundSchema: z.ZodType<
  ActivityCreateRequestValue$Outbound,
  z.ZodTypeDef,
  ActivityCreateRequestValue
> = z.union([
  z.lazy(() => ActivityCreateRequestValue4$outboundSchema),
  z.string(),
  z.number(),
  z.boolean(),
  z.array(z.string()),
  z.array(z.lazy(() => ActivityCreateRequestValue6$outboundSchema)),
]);
 ...
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export namespace ActivityCreateRequestValue$ {
  /** @deprecated use `ActivityCreateRequestValue$inboundSchema` instead. */
  export const inboundSchema = ActivityCreateRequestValue$inboundSchema;
  /** @deprecated use `ActivityCreateRequestValue$outboundSchema` instead. */
  export const outboundSchema = ActivityCreateRequestValue$outboundSchema;
  /** @deprecated use `ActivityCreateRequestValue$Outbound` instead. */
  export type Outbound = ActivityCreateRequestValue$Outbound;
}

export function activityCreateRequestValueToJSON(
  activityCreateRequestValue: ActivityCreateRequestValue,
): string {
  return JSON.stringify(
    ActivityCreateRequestValue$outboundSchema.parse(activityCreateRequestValue),
  );
}

export function activityCreateRequestValueFromJSON(
  jsonString: string,
): SafeParseResult<ActivityCreateRequestValue, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => ActivityCreateRequestValue$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'ActivityCreateRequestValue' from JSON`,
  );
}

/** @internal */
export const ActivityCreateRequestCustomFields$inboundSchema: z.ZodType<
  ActivityCreateRequestCustomFields,
  z.ZodTypeDef,
  unknown
> = z.object({
...
/** @internal */
export type ActivityCreateRequestCustomFields$Outbound = {
  id: string | null;
  name?: string | null | undefined;
  description?: string | null | undefined;
  value?:
...
/** @internal */
export const ActivityCreateRequestCustomFields$outboundSchema: z.ZodType<
  ActivityCreateRequestCustomFields$Outbound,
  z.ZodTypeDef,
  ActivityCreateRequestCustomFields
> = z.object({
  id: z.nullable(z.string()),
 ...
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export namespace ActivityCreateRequestCustomFields$ {
  /** @deprecated use `ActivityCreateRequestCustomFields$inboundSchema` instead. */
  export const inboundSchema = ActivityCreateRequestCustomFields$inboundSchema;
  /** @deprecated use `ActivityCreateRequestCustomFields$outboundSchema` instead. */
  export const outboundSchema =
    ActivityCreateRequestCustomFields$outboundSchema;
  /** @deprecated use `ActivityCreateRequestCustomFields$Outbound` instead. */
  export type Outbound = ActivityCreateRequestCustomFields$Outbound;
}

export function activityCreateRequestCustomFieldsToJSON(
  activityCreateRequestCustomFields: ActivityCreateRequestCustomFields,
): string {
  return JSON.stringify(
    ActivityCreateRequestCustomFields$outboundSchema.parse(
      activityCreateRequestCustomFields,
    ),
  );
}

export function activityCreateRequestCustomFieldsFromJSON(
  jsonString: string,
): SafeParseResult<ActivityCreateRequestCustomFields, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => ActivityCreateRequestCustomFields$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'ActivityCreateRequestCustomFields' from JSON`,
  );
}
...
/** @internal */
export const ActivityCreateRequestAttendees$inboundSchema: z.ZodType<
  ActivityCreateRequestAttendees,
  z.ZodTypeDef,
  unknown
> = z.object({
  name: z.nullable(z.string()).optional(),
...
/** @internal */
export type ActivityCreateRequestAttendees$Outbound = {
  name?: string | null | undefined;
...
/** @internal */
export const ActivityCreateRequestAttendees$outboundSchema: z.ZodType<
  ActivityCreateRequestAttendees$Outbound,
  z.ZodTypeDef,
  ActivityCreateRequestAttendees
> = z.object({
  name: z.nullable(z.string()).optional(),
 ...
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export namespace ActivityCreateRequestAttendees$ {
  /** @deprecated use `ActivityCreateRequestAttendees$inboundSchema` instead. */
  export const inboundSchema = ActivityCreateRequestAttendees$inboundSchema;
  /** @deprecated use `ActivityCreateRequestAttendees$outboundSchema` instead. */
  export const outboundSchema = ActivityCreateRequestAttendees$outboundSchema;
  /** @deprecated use `ActivityCreateRequestAttendees$Outbound` instead. */
  export type Outbound = ActivityCreateRequestAttendees$Outbound;
}

export function activityCreateRequestAttendeesToJSON(
  activityCreateRequestAttendees: ActivityCreateRequestAttendees,
): string {
  return JSON.stringify(
    ActivityCreateRequestAttendees$outboundSchema.parse(
      activityCreateRequestAttendees,
    ),
  );
}

export function activityCreateRequestAttendeesFromJSON(
  jsonString: string,
): SafeParseResult<ActivityCreateRequestAttendees, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => ActivityCreateRequestAttendees$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'ActivityCreateRequestAttendees' from JSON`,
  );
}

/** @internal */
export const ActivityCreateRequestExtendPaths$inboundSchema: z.ZodType<
  ActivityCreateRequestExtendPaths,
  z.ZodTypeDef,
  unknown
> = z.object({
  path: z.string(),
...
/** @internal */
export type ActivityCreateRequestExtendPaths$Outbound = {
  path: string;
  value?: any | undefined;
};

/** @internal */
export const ActivityCreateRequestExtendPaths$outboundSchema: z.ZodType<
  ActivityCreateRequestExtendPaths$Outbound,
  z.ZodTypeDef,
  ActivityCreateRequestExtendPaths
> = z.object({
  path: z.string(),
 ...
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export namespace ActivityCreateRequestExtendPaths$ {
  /** @deprecated use `ActivityCreateRequestExtendPaths$inboundSchema` instead. */
  export const inboundSchema = ActivityCreateRequestExtendPaths$inboundSchema;
  /** @deprecated use `ActivityCreateRequestExtendPaths$outboundSchema` instead. */
  export const outboundSchema = ActivityCreateRequestExtendPaths$outboundSchema;
  /** @deprecated use `ActivityCreateRequestExtendPaths$Outbound` instead. */
  export type Outbound = ActivityCreateRequestExtendPaths$Outbound;
}

export function activityCreateRequestExtendPathsToJSON(
  activityCreateRequestExtendPaths: ActivityCreateRequestExtendPaths,
): string {
  return JSON.stringify(
    ActivityCreateRequestExtendPaths$outboundSchema.parse(
      activityCreateRequestExtendPaths,
    ),
  );
}

export function activityCreateRequestExtendPathsFromJSON(
  jsonString: string,
): SafeParseResult<ActivityCreateRequestExtendPaths, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => ActivityCreateRequestExtendPaths$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'ActivityCreateRequestExtendPaths' from JSON`,
  );
}

/** @internal */
export const ActivityCreateRequestPassThrough$inboundSchema: z.ZodType<
  ActivityCreateRequestPassThrough,
  z.ZodTypeDef,
  unknown
> = z.object({
  service_id: z.string(),
  ...
  extend_paths: z.array(
    z.lazy(() => ActivityCreateRequestExtendPaths$inboundSchema),
  ).optional(),
}).transform((v) => {
  return remap$(v, {
...
/** @internal */
export type ActivityCreateRequestPassThrough$Outbound = {
  service_id: string;
  operation_id?: string | undefined;
  extend_object?: { [k: string]: any } | undefined;
  extend_paths?: Array<ActivityCreateRequestExtendPaths$Outbound> | undefined;
};

/** @internal */
export const ActivityCreateRequestPassThrough$outboundSchema: z.ZodType<
  ActivityCreateRequestPassThrough$Outbound,
  z.ZodTypeDef,
  ActivityCreateRequestPassThrough
> = z.object({
  serviceId: z.string(),
  ...
  extendPaths: z.array(
    z.lazy(() => ActivityCreateRequestExtendPaths$outboundSchema),
  ).optional(),
}).transform((v) => {
  return remap$(v, {
 ...
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export namespace ActivityCreateRequestPassThrough$ {
  /** @deprecated use `ActivityCreateRequestPassThrough$inboundSchema` instead. */
  export const inboundSchema = ActivityCreateRequestPassThrough$inboundSchema;
  /** @deprecated use `ActivityCreateRequestPassThrough$outboundSchema` instead. */
  export const outboundSchema = ActivityCreateRequestPassThrough$outboundSchema;
  /** @deprecated use `ActivityCreateRequestPassThrough$Outbound` instead. */
  export type Outbound = ActivityCreateRequestPassThrough$Outbound;
}

export function activityCreateRequestPassThroughToJSON(
  activityCreateRequestPassThrough: ActivityCreateRequestPassThrough,
): string {
  return JSON.stringify(
    ActivityCreateRequestPassThrough$outboundSchema.parse(
      activityCreateRequestPassThrough,
    ),
  );
}

export function activityCreateRequestPassThroughFromJSON(
  jsonString: string,
): SafeParseResult<ActivityCreateRequestPassThrough, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => ActivityCreateRequestPassThrough$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'ActivityCreateRequestPassThrough' from JSON`,
  );
}

/** @internal */
export const ActivityCreateRequest$inboundSchema: z.ZodType<
...
> = z.object({
  ...
  type: z.nullable(ActivityCreateRequestType$inboundSchema),
  ...
  custom_fields: z.array(
    z.lazy(() => ActivityCreateRequestCustomFields$inboundSchema),
  ).optional(),
  attendees: z.array(z.lazy(() => ActivityCreateRequestAttendees$inboundSchema))
    .optional(),
  pass_through: z.array(
    z.lazy(() => ActivityCreateRequestPassThrough$inboundSchema),
  ).optional(),
}).transform((v) => {
  return remap$(v, {
...
/** @internal */
export type ActivityCreateRequest$Outbound = {
  ...
  custom_fields?: Array<ActivityCreateRequestCustomFields$Outbound> | undefined;
  attendees?: Array<ActivityCreateRequestAttendees$Outbound> | undefined;
  pass_through?: Array<ActivityCreateRequestPassThrough$Outbound> | undefined;
};

/** @internal */
export const ActivityCreateRequest$outboundSchema: z.ZodType<
  ActivityCreateRequest$Outbound,
  z.ZodTypeDef,
  ActivityCreateRequest
> = z.object({
  ...
  type: z.nullable(ActivityCreateRequestType$outboundSchema),
  title: z.nullable(z.string()).optional(),
  description: z.nullable(z.string()).optional(),
  note: z.nullable(z.string()).optional(),
  location: z.nullable(z.string()).optional(),
  ...
  customFields: z.array(
    z.lazy(() => ActivityCreateRequestCustomFields$outboundSchema),
  ).optional(),
  attendees: z.array(
    z.lazy(() => ActivityCreateRequestAttendees$outboundSchema),
  ).optional(),
  passThrough: z.array(
    z.lazy(() => ActivityCreateRequestPassThrough$outboundSchema),
  ).optional(),
}).transform((v) => {
  return remap$(v, {
...
export namespace ActivityCreateRequest$ {
  /** @deprecated use `ActivityCreateRequest$inboundSchema` instead. */
  export const inboundSchema = ActivityCreateRequest$inboundSchema;
  /** @deprecated use `ActivityCreateRequest$outboundSchema` instead. */
  export const outboundSchema = ActivityCreateRequest$outboundSchema;
  /** @deprecated use `ActivityCreateRequest$Outbound` instead. */
  export type Outbound = ActivityCreateRequest$Outbound;
}

export function activityCreateRequestToJSON(
  activityCreateRequest: ActivityCreateRequest,
): string {
  return JSON.stringify(
    ActivityCreateRequest$outboundSchema.parse(activityCreateRequest),
  );
}

export function activityCreateRequestFromJSON(
  jsonString: string,
): SafeParseResult<ActivityCreateRequest, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => ActivityCreateRequest$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'ActivityCreateRequest' from JSON`,
  );
}
