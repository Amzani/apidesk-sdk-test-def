 ...
 */
export const UserCreateRequestType = {
  Primary: "primary",
  Secondary: "secondary",
  Home: "home",
  Office: "office",
 ...
 * Specifies the type of address, such as 'home', 'work', or 'billing'. This classification helps in organizing and retrieving addresses based on their usage context. It is important for applications that need to differentiate between various address types for operations like shipping or invoicing.
 */
export type UserCreateRequestType = ClosedEnum<typeof UserCreateRequestType>;

export type UserCreateRequestAddresses = {
  /**
   ...
   * Specifies the type of address, such as 'home', 'work', or 'billing'. This classification helps in organizing and retrieving addresses based on their usage context. It is important for applications that need to differentiate between various address types for operations like shipping or invoicing.
   */
  type?: UserCreateRequestType | null | undefined;
  /**
 ...
 */
export const UserCreateRequestPhoneNumbersType = {
  Primary: "primary",
  Secondary: "secondary",
  Home: "home",
  Work: "work",
 ...
 * The type of phone number, indicating its purpose or usage context, such as 'mobile', 'home', 'work', etc. This classification helps in organizing contact methods and is crucial for determining the best way to reach a user. It is optional but recommended for clarity in communication preferences.
 */
export type UserCreateRequestPhoneNumbersType = ClosedEnum<
  typeof UserCreateRequestPhoneNumbersType
>;

export type UserCreateRequestPhoneNumbers = {
  /**
   ...
   * The type of phone number, indicating its purpose or usage context, such as 'mobile', 'home', 'work', etc. This classification helps in organizing contact methods and is crucial for determining the best way to reach a user. It is optional but recommended for clarity in communication preferences.
   */
  type?: UserCreateRequestPhoneNumbersType | null | undefined;
};
 ...
 */
export const UserCreateRequestEmailsType = {
  Primary: "primary",
  Secondary: "secondary",
  Work: "work",
  Personal: "personal",
 ...
 * Specifies the category or role of the email address associated with the user, such as 'work', 'personal', or 'other'. This helps in distinguishing between different types of email addresses for effective communication management within the CRM system. It is not mandatory, but providing this information can enhance the clarity and organization of user contact details.
 */
export type UserCreateRequestEmailsType = ClosedEnum<
  typeof UserCreateRequestEmailsType
>;

export type UserCreateRequestEmails = {
  /**
   ...
   * Specifies the category or role of the email address associated with the user, such as 'work', 'personal', or 'other'. This helps in distinguishing between different types of email addresses for effective communication management within the CRM system. It is not mandatory, but providing this information can enhance the clarity and organization of user contact details.
   */
  type?: UserCreateRequestEmailsType | null | undefined;
};

export type UserCreateRequestExtendPaths = {
  /**
...
export type UserCreateRequestPassThrough = {
  /**
   ...
   */
  extendPaths?: Array<UserCreateRequestExtendPaths> | undefined;
};
...
export type UserCreateRequest = {
   ...
   */
  addresses?: Array<UserCreateRequestAddresses> | undefined;
  /**
   ...
   */
  phoneNumbers?: Array<UserCreateRequestPhoneNumbers> | undefined;
  /**
   ...
   */
  emails: Array<UserCreateRequestEmails>;
  /**
   ...
   */
  passThrough?: Array<UserCreateRequestPassThrough> | undefined;
};

/** @internal */
export const UserCreateRequestType$inboundSchema: z.ZodNativeEnum<
  typeof UserCreateRequestType
> = z.nativeEnum(UserCreateRequestType);

/** @internal */
export const UserCreateRequestType$outboundSchema: z.ZodNativeEnum<
  typeof UserCreateRequestType
> = UserCreateRequestType$inboundSchema;

/**
 * @internal
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export namespace UserCreateRequestType$ {
  /** @deprecated use `UserCreateRequestType$inboundSchema` instead. */
  export const inboundSchema = UserCreateRequestType$inboundSchema;
  /** @deprecated use `UserCreateRequestType$outboundSchema` instead. */
  export const outboundSchema = UserCreateRequestType$outboundSchema;
}

/** @internal */
export const UserCreateRequestAddresses$inboundSchema: z.ZodType<
  UserCreateRequestAddresses,
  z.ZodTypeDef,
  unknown
> = z.object({
  id: z.nullable(z.string()).optional(),
  type: z.nullable(UserCreateRequestType$inboundSchema).optional(),
...
/** @internal */
export type UserCreateRequestAddresses$Outbound = {
  id?: string | null | undefined;
...
/** @internal */
export const UserCreateRequestAddresses$outboundSchema: z.ZodType<
  UserCreateRequestAddresses$Outbound,
  z.ZodTypeDef,
  UserCreateRequestAddresses
> = z.object({
  id: z.nullable(z.string()).optional(),
  type: z.nullable(UserCreateRequestType$outboundSchema).optional(),
  string: z.nullable(z.string()).optional(),
  name: z.nullable(z.string()).optional(),
  line1: z.nullable(z.string()).optional(),
  line2: z.nullable(z.string()).optional(),
 ...
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export namespace UserCreateRequestAddresses$ {
  /** @deprecated use `UserCreateRequestAddresses$inboundSchema` instead. */
  export const inboundSchema = UserCreateRequestAddresses$inboundSchema;
  /** @deprecated use `UserCreateRequestAddresses$outboundSchema` instead. */
  export const outboundSchema = UserCreateRequestAddresses$outboundSchema;
  /** @deprecated use `UserCreateRequestAddresses$Outbound` instead. */
  export type Outbound = UserCreateRequestAddresses$Outbound;
}

export function userCreateRequestAddressesToJSON(
  userCreateRequestAddresses: UserCreateRequestAddresses,
): string {
  return JSON.stringify(
    UserCreateRequestAddresses$outboundSchema.parse(userCreateRequestAddresses),
  );
}

export function userCreateRequestAddressesFromJSON(
  jsonString: string,
): SafeParseResult<UserCreateRequestAddresses, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserCreateRequestAddresses$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserCreateRequestAddresses' from JSON`,
  );
}

/** @internal */
export const UserCreateRequestPhoneNumbersType$inboundSchema: z.ZodNativeEnum<
  typeof UserCreateRequestPhoneNumbersType
> = z.nativeEnum(UserCreateRequestPhoneNumbersType);

/** @internal */
export const UserCreateRequestPhoneNumbersType$outboundSchema: z.ZodNativeEnum<
  typeof UserCreateRequestPhoneNumbersType
> = UserCreateRequestPhoneNumbersType$inboundSchema;

/**
 * @internal
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export namespace UserCreateRequestPhoneNumbersType$ {
  /** @deprecated use `UserCreateRequestPhoneNumbersType$inboundSchema` instead. */
  export const inboundSchema = UserCreateRequestPhoneNumbersType$inboundSchema;
  /** @deprecated use `UserCreateRequestPhoneNumbersType$outboundSchema` instead. */
  export const outboundSchema =
    UserCreateRequestPhoneNumbersType$outboundSchema;
}

/** @internal */
export const UserCreateRequestPhoneNumbers$inboundSchema: z.ZodType<
  UserCreateRequestPhoneNumbers,
  z.ZodTypeDef,
  unknown
> = z.object({
  id: z.nullable(z.string()).optional(),
  ...
  type: z.nullable(UserCreateRequestPhoneNumbersType$inboundSchema).optional(),
}).transform((v) => {
  return remap$(v, {
...
/** @internal */
export type UserCreateRequestPhoneNumbers$Outbound = {
  id?: string | null | undefined;
...
/** @internal */
export const UserCreateRequestPhoneNumbers$outboundSchema: z.ZodType<
  UserCreateRequestPhoneNumbers$Outbound,
  z.ZodTypeDef,
  UserCreateRequestPhoneNumbers
> = z.object({
  id: z.nullable(z.string()).optional(),
  ...
  number: z.string(),
  extension: z.nullable(z.string()).optional(),
  type: z.nullable(UserCreateRequestPhoneNumbersType$outboundSchema).optional(),
}).transform((v) => {
  return remap$(v, {
 ...
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export namespace UserCreateRequestPhoneNumbers$ {
  /** @deprecated use `UserCreateRequestPhoneNumbers$inboundSchema` instead. */
  export const inboundSchema = UserCreateRequestPhoneNumbers$inboundSchema;
  /** @deprecated use `UserCreateRequestPhoneNumbers$outboundSchema` instead. */
  export const outboundSchema = UserCreateRequestPhoneNumbers$outboundSchema;
  /** @deprecated use `UserCreateRequestPhoneNumbers$Outbound` instead. */
  export type Outbound = UserCreateRequestPhoneNumbers$Outbound;
}

export function userCreateRequestPhoneNumbersToJSON(
  userCreateRequestPhoneNumbers: UserCreateRequestPhoneNumbers,
): string {
  return JSON.stringify(
    UserCreateRequestPhoneNumbers$outboundSchema.parse(
      userCreateRequestPhoneNumbers,
    ),
  );
}

export function userCreateRequestPhoneNumbersFromJSON(
  jsonString: string,
): SafeParseResult<UserCreateRequestPhoneNumbers, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserCreateRequestPhoneNumbers$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserCreateRequestPhoneNumbers' from JSON`,
  );
}

/** @internal */
export const UserCreateRequestEmailsType$inboundSchema: z.ZodNativeEnum<
  typeof UserCreateRequestEmailsType
> = z.nativeEnum(UserCreateRequestEmailsType);

/** @internal */
export const UserCreateRequestEmailsType$outboundSchema: z.ZodNativeEnum<
  typeof UserCreateRequestEmailsType
> = UserCreateRequestEmailsType$inboundSchema;

/**
 * @internal
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export namespace UserCreateRequestEmailsType$ {
  /** @deprecated use `UserCreateRequestEmailsType$inboundSchema` instead. */
  export const inboundSchema = UserCreateRequestEmailsType$inboundSchema;
  /** @deprecated use `UserCreateRequestEmailsType$outboundSchema` instead. */
  export const outboundSchema = UserCreateRequestEmailsType$outboundSchema;
}

/** @internal */
export const UserCreateRequestEmails$inboundSchema: z.ZodType<
  UserCreateRequestEmails,
  z.ZodTypeDef,
  unknown
> = z.object({
  id: z.nullable(z.string()).optional(),
  email: z.nullable(z.string()),
  type: z.nullable(UserCreateRequestEmailsType$inboundSchema).optional(),
});

/** @internal */
export type UserCreateRequestEmails$Outbound = {
  id?: string | null | undefined;
  email: string | null;
  type?: string | null | undefined;
};
...
/** @internal */
export const UserCreateRequestEmails$outboundSchema: z.ZodType<
  UserCreateRequestEmails$Outbound,
  z.ZodTypeDef,
  UserCreateRequestEmails
> = z.object({
  id: z.nullable(z.string()).optional(),
  email: z.nullable(z.string()),
  type: z.nullable(UserCreateRequestEmailsType$outboundSchema).optional(),
});
 ...
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export namespace UserCreateRequestEmails$ {
  /** @deprecated use `UserCreateRequestEmails$inboundSchema` instead. */
  export const inboundSchema = UserCreateRequestEmails$inboundSchema;
  /** @deprecated use `UserCreateRequestEmails$outboundSchema` instead. */
  export const outboundSchema = UserCreateRequestEmails$outboundSchema;
  /** @deprecated use `UserCreateRequestEmails$Outbound` instead. */
  export type Outbound = UserCreateRequestEmails$Outbound;
}

export function userCreateRequestEmailsToJSON(
  userCreateRequestEmails: UserCreateRequestEmails,
): string {
  return JSON.stringify(
    UserCreateRequestEmails$outboundSchema.parse(userCreateRequestEmails),
  );
}

export function userCreateRequestEmailsFromJSON(
  jsonString: string,
): SafeParseResult<UserCreateRequestEmails, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserCreateRequestEmails$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserCreateRequestEmails' from JSON`,
  );
}

/** @internal */
export const UserCreateRequestExtendPaths$inboundSchema: z.ZodType<
  UserCreateRequestExtendPaths,
  z.ZodTypeDef,
  unknown
> = z.object({
  path: z.string(),
...
/** @internal */
export type UserCreateRequestExtendPaths$Outbound = {
  path: string;
  value?: any | undefined;
};

/** @internal */
export const UserCreateRequestExtendPaths$outboundSchema: z.ZodType<
  UserCreateRequestExtendPaths$Outbound,
  z.ZodTypeDef,
  UserCreateRequestExtendPaths
> = z.object({
  path: z.string(),
 ...
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export namespace UserCreateRequestExtendPaths$ {
  /** @deprecated use `UserCreateRequestExtendPaths$inboundSchema` instead. */
  export const inboundSchema = UserCreateRequestExtendPaths$inboundSchema;
  /** @deprecated use `UserCreateRequestExtendPaths$outboundSchema` instead. */
  export const outboundSchema = UserCreateRequestExtendPaths$outboundSchema;
  /** @deprecated use `UserCreateRequestExtendPaths$Outbound` instead. */
  export type Outbound = UserCreateRequestExtendPaths$Outbound;
}

export function userCreateRequestExtendPathsToJSON(
  userCreateRequestExtendPaths: UserCreateRequestExtendPaths,
): string {
  return JSON.stringify(
    UserCreateRequestExtendPaths$outboundSchema.parse(
      userCreateRequestExtendPaths,
    ),
  );
}

export function userCreateRequestExtendPathsFromJSON(
  jsonString: string,
): SafeParseResult<UserCreateRequestExtendPaths, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserCreateRequestExtendPaths$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserCreateRequestExtendPaths' from JSON`,
  );
}

/** @internal */
export const UserCreateRequestPassThrough$inboundSchema: z.ZodType<
  UserCreateRequestPassThrough,
  z.ZodTypeDef,
  unknown
> = z.object({
  service_id: z.string(),
  ...
  extend_paths: z.array(
    z.lazy(() => UserCreateRequestExtendPaths$inboundSchema),
  ).optional(),
}).transform((v) => {
  return remap$(v, {
...
/** @internal */
export type UserCreateRequestPassThrough$Outbound = {
  service_id: string;
  operation_id?: string | undefined;
  extend_object?: { [k: string]: any } | undefined;
  extend_paths?: Array<UserCreateRequestExtendPaths$Outbound> | undefined;
};

/** @internal */
export const UserCreateRequestPassThrough$outboundSchema: z.ZodType<
  UserCreateRequestPassThrough$Outbound,
  z.ZodTypeDef,
  UserCreateRequestPassThrough
> = z.object({
  serviceId: z.string(),
  ...
  extendPaths: z.array(
    z.lazy(() => UserCreateRequestExtendPaths$outboundSchema),
  ).optional(),
}).transform((v) => {
  return remap$(v, {
 ...
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export namespace UserCreateRequestPassThrough$ {
  /** @deprecated use `UserCreateRequestPassThrough$inboundSchema` instead. */
  export const inboundSchema = UserCreateRequestPassThrough$inboundSchema;
  /** @deprecated use `UserCreateRequestPassThrough$outboundSchema` instead. */
  export const outboundSchema = UserCreateRequestPassThrough$outboundSchema;
  /** @deprecated use `UserCreateRequestPassThrough$Outbound` instead. */
  export type Outbound = UserCreateRequestPassThrough$Outbound;
}

export function userCreateRequestPassThroughToJSON(
  userCreateRequestPassThrough: UserCreateRequestPassThrough,
): string {
  return JSON.stringify(
    UserCreateRequestPassThrough$outboundSchema.parse(
      userCreateRequestPassThrough,
    ),
  );
}

export function userCreateRequestPassThroughFromJSON(
  jsonString: string,
): SafeParseResult<UserCreateRequestPassThrough, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => UserCreateRequestPassThrough$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'UserCreateRequestPassThrough' from JSON`,
  );
}
...
> = z.object({
  ...
  addresses: z.array(z.lazy(() => UserCreateRequestAddresses$inboundSchema))
    .optional(),
  phone_numbers: z.array(
    z.lazy(() => UserCreateRequestPhoneNumbers$inboundSchema),
  ).optional(),
  emails: z.array(z.lazy(() => UserCreateRequestEmails$inboundSchema)),
  pass_through: z.array(
    z.lazy(() => UserCreateRequestPassThrough$inboundSchema),
  ).optional(),
}).transform((v) => {
  return remap$(v, {
    "parent_id": "parentId",
...
export type UserCreateRequest$Outbound = {
  ...
  status?: string | null | undefined;
  password?: string | null | undefined;
  addresses?: Array<UserCreateRequestAddresses$Outbound> | undefined;
  phone_numbers?: Array<UserCreateRequestPhoneNumbers$Outbound> | undefined;
  emails: Array<UserCreateRequestEmails$Outbound>;
  pass_through?: Array<UserCreateRequestPassThrough$Outbound> | undefined;
};
...
> = z.object({
  ...
  status: z.nullable(z.string()).optional(),
  password: z.nullable(z.string()).optional(),
  addresses: z.array(z.lazy(() => UserCreateRequestAddresses$outboundSchema))
    .optional(),
  phoneNumbers: z.array(
    z.lazy(() => UserCreateRequestPhoneNumbers$outboundSchema),
  ).optional(),
  emails: z.array(z.lazy(() => UserCreateRequestEmails$outboundSchema)),
  passThrough: z.array(
    z.lazy(() => UserCreateRequestPassThrough$outboundSchema),
  ).optional(),
}).transform((v) => {
  return remap$(v, {
    parentId: "parent_id",
