...
export async function hrisEmployeeSchedulesList(
  ...
  Result<
    ...
    | errors.HrisEmployeeSchedulesAllResponseBody
    | errors.HrisEmployeeSchedulesAllHrisEmployeeSchedulesResponseBody
    | errors.HrisEmployeeSchedulesAllHrisEmployeeSchedulesResponseResponseBody
    | errors.HrisEmployeeSchedulesAllHrisEmployeeSchedulesResponse404ResponseBody
    | errors.HrisEmployeeSchedulesAllHrisEmployeeSchedulesResponse422ResponseBody
    | APIError
    | SDKValidationError
    | UnexpectedClientError
    | InvalidRequestError
