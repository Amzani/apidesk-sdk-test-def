...
export async function hrisTimeOffRequestsDelete(
  ...
  Result<
    ...
    | errors.HrisTimeOffRequestsDeleteResponseBody
    | errors.HrisTimeOffRequestsDeleteHrisTimeOffRequestsResponseBody
    | errors.HrisTimeOffRequestsDeleteHrisTimeOffRequestsResponseResponseBody
    | errors.HrisTimeOffRequestsDeleteHrisTimeOffRequestsResponse404ResponseBody
    | errors.HrisTimeOffRequestsDeleteHrisTimeOffRequestsResponse422ResponseBody
    | APIError
    | SDKValidationError
    | UnexpectedClientError
    | InvalidRequestError
