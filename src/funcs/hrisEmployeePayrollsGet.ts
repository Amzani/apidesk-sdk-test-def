...
export async function hrisEmployeePayrollsGet(
  ...
  Result<
    ...
    | errors.HrisEmployeePayrollsOneResponseBody
    | errors.HrisEmployeePayrollsOneHrisEmployeePayrollsResponseBody
    | errors.HrisEmployeePayrollsOneHrisEmployeePayrollsResponseResponseBody
    | errors.HrisEmployeePayrollsOneHrisEmployeePayrollsResponse404ResponseBody
    | errors.HrisEmployeePayrollsOneHrisEmployeePayrollsResponse422ResponseBody
    | APIError
    | SDKValidationError
    | UnexpectedClientError
    | InvalidRequestError
