...
export async function hrisTimeOffRequestsList(
  ...
  PageIterator<
    Result<
      ...
      | errors.HrisTimeOffRequestsAllResponseBody
      | errors.HrisTimeOffRequestsAllHrisTimeOffRequestsResponseBody
      | errors.HrisTimeOffRequestsAllHrisTimeOffRequestsResponseResponseBody
      | errors.HrisTimeOffRequestsAllHrisTimeOffRequestsResponse404ResponseBody
      | errors.HrisTimeOffRequestsAllHrisTimeOffRequestsResponse422ResponseBody
      | APIError
      | SDKValidationError
      | UnexpectedClientError
      | InvalidRequestError
